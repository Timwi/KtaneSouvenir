...
{
    public override string FormatModuleName(TextQuestion question, bool addSolveCount, int numSolved) => addSolveCount
    ...
    protected override Dictionary<TextQuestion, TranslationInfo> _translations => new()
    {
