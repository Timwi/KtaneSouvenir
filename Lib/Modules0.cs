...
{
    private IEnumerator<YieldInstruction> ProcessMorseWoF(ModuleData module)
    {
    ...
    private IEnumerator<YieldInstruction> Process3DTapCode(ModuleData module)
    {
    ...
    private IEnumerator<YieldInstruction> Process3DTunnels(ModuleData module)
    {
    ...
    private IEnumerator<YieldInstruction> Process3NPlus1(ModuleData module)
    {
    ...
    private IEnumerator<YieldInstruction> Process9Ball(ModuleData module)
    {
