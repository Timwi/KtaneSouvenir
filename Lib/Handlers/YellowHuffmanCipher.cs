...
public enum SYellowHuffmanCipher
{
    ...
    [Discriminator("the Yellow Huffman Cipher that had {0} on the {1} screen on page {2}", Arguments = ["AMBUSH", "top", "1", "BANZAI", "middle", "1", "BIGGER", "bottom", "1", "GAMBLE", "top", "2", "KETOSE", "middle", "2", "OCULUS", "bottom", "2"], ArgumentGroupSize = 3, TranslateArguments = [false, true, false])]
    DScreen
}
...
public partial class SouvenirModule
{
    ...
    private IEnumerator<SouvenirInstruction> ProcessYellowHuffmanCipher(ModuleData module) =>
        processCompressionCiphers(module, "YellowHuffmanCipherModule", SYellowHuffmanCipher.QScreen, SYellowHuffmanCipher.DScreen);
}
