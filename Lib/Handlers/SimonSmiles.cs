...
{
    [Question("What sound did the {1} button press make in {0}?", ThreeColumns3Answers, Arguments = [QandA.Ordinal], ArgumentGroupSize = 1, AnswerType = InfoType.Audio, AudioFieldName = "SimonSmilesAudio", AudioSizeMultiplier = 6)]
    Sounds
}
