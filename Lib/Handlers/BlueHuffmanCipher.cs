...
{
    [SouvenirHandler("BlueHuffmanCipherModule", "Blue Huffman Cipher", typeof(SBlueHuffmanCipher), "Timwi")]
    ...
    private IEnumerator<SouvenirInstruction> ProcessBlueHuffmanCipher(ModuleData module) =>
        processCompressionCiphers(module, "BlueHuffmanCipherModule", SBlueHuffmanCipher.Screen);
}
