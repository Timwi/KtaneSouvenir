...
{
    [Question("What were the call samples {1} of {0}?", TwoColumns4Answers, AnswerType = InfoType.Audio, ForeignAudioID = Sounds.Generated, TranslateArguments = [true], Arguments = ["played in the first stage", "added in the second stage", "added in the third stage"], ArgumentGroupSize = 1)]
    Samples
}
