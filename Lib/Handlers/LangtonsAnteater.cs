...
{
    [Question("Which of these squares was initially {1} in {0}?", ThreeColumns6Answers, AnswerType = InfoType.Sprites, Arguments = ["black", "white"], ArgumentGroupSize = 1, TranslateArguments = [true])]
