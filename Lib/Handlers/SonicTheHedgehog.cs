...
public enum SSonicTheHedgehog
{
    ...
    [SouvenirQuestion("Which sound was played by the {1} screen on {0}?", TwoColumns4Answers, Type = AnswerType.Audio, AudioFieldName = "SonicTheHedgehogAudio", AudioSizeMultiplier = 4, Arguments = ["Running Boots", "Invincibility", "Extra Life", "Rings"], TranslateFormatArgs = [true], ArgumentGroupSize = 1)]
    Sounds
}
