...
{
    [Question("What was the color of the {1} LED in {0}?", ThreeColumns6Answers, "Black", "Red", "Green", "Blue", "Magenta", "Cyan", "Yellow", "White", TranslateAnswers = true, Arguments = [QandA.Ordinal], ArgumentGroupSize = 1)]
    Display
}
