...
{
    [Question("What was the 2FAST™ value when you solved {0}?", ThreeColumns6Answers)]
...
{
    [Handler("pwDestroyer", "Password Destroyer", typeof(SPasswordDestroyer), "Eltrick")]
    [ManualQuestion("What was the 2FAST™ value?")]
