...
{
    [Handler("monsplodeFight", "Monsplode, Fight!", typeof(SMonsplodeFight), "Timwi")]
    [ManualQuestion("Which creature was displayed?")]
    [ManualQuestion("Which moves were selectable?")]
