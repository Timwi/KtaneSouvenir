...
{
    [SouvenirQuestion("What time was shown when the clock struck {1} on {0}?", ThreeColumns6Answers, Arguments = ["1:00", "2:00", "3:00", "4:00", "5:00", "6:00", "7:00", "8:00", "9:00", "10:00", "11:00", "12:00"], ArgumentGroupSize = 1, TranslatableStrings = ["the Hickory Dickory Dock which showed {0}:{1:00} when it struck {2}"])]
