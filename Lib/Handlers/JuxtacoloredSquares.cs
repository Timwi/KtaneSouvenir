...
public enum SJuxtacoloredSquares
{
    ...
    [SouvenirQuestion("Which square was {1} in {0}?", ThreeColumns6Answers, Type = AnswerType.Sprites, Arguments = ["red", "blue", "yellow", "green", "magenta", "orange", "cyan", "purple", "chestnut", "brown", "mauve", "azure", "jade", "forest", "gray", "black"], ArgumentGroupSize = 1, TranslateFormatArgs = [true])]
