...
public enum SMurder
{
    [SouvenirQuestion("Which of these was {1} in {0}?", TwoColumns4Answers, "Miss Scarlett", "Professor Plum", "Mrs Peacock", "Reverend Green", "Colonel Mustard", "Mrs White", TranslateAnswers = true, Arguments = ["a suspect but not the murderer", "not a suspect"], ArgumentGroupSize = 1, TranslateFormatArgs = [true])]
    Suspect,
    
    [SouvenirQuestion("Which of these was {1} in {0}?", TwoColumns4Answers, "Candlestick", "Dagger", "Lead Pipe", "Revolver", "Rope", "Spanner", TranslateAnswers = true, Arguments = ["a potential weapon but not the murder weapon", "not a potential weapon"], ArgumentGroupSize = 1, TranslateFormatArgs = [true])]
    Weapon,
