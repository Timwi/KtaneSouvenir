...
{
    [Question("What two-digit number was given in {0}?", ThreeColumns6Answers)]
...
{
    [Handler("Numbers", "Numbers", typeof(SNumbers), "BigCrunch22")]
    [ManualQuestion("What two-digit number was given?")]
