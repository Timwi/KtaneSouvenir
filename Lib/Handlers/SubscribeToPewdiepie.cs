...
{
    [Question("How many subscribers does {1} have in {0}?", TwoColumns4Answers, Arguments = ["PewDiePie", "T-Series"], ArgumentGroupSize = 1, TranslateArguments = [true])]
...
{
    [Handler("subscribeToPewdiepie", "Subscribe to Pewdiepie", typeof(SSubscribeToPewdiepie), "BigCrunch22")]
    [ManualQuestion("How many subscribers do Pewdiepie and T-Series have?")]
