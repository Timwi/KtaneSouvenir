...
public enum SBoxing
{
    ...
    [SouvenirQuestion("What was the {1} of the contestant with strength rating {2} on {0}?", TwoColumns4Answers, ExampleAnswers = ["Muhammad", "Mike", "Floyd", "Joe", "George", "Manny", "Sugar Ray", "Evander"], TranslateFormatArgs = [true, false], Arguments = ["first name", "0", "first name", "1", "first name", "2", "last name", "0", "last name", "1", "last name", "2", "substitute’s first name", "0", "substitute’s first name", "1", "substitute’s first name", "2", "substitute’s last name", "0", "substitute’s last name", "1", "substitute’s last name", "2"], ArgumentGroupSize = 2)]
    ContestantByStrength,
    
    [SouvenirQuestion("Which {1} appeared on {0}?", TwoColumns4Answers, ExampleAnswers = ["Muhammad", "Mike", "Floyd", "Joe", "George", "Manny", "Sugar Ray", "Evander"], Arguments = ["contestant’s first name", "contestant’s last name", "substitute’s first name", "substitute’s last name"], ArgumentGroupSize = 1, TranslateFormatArgs = [true])]
    Names
}
