...
public enum SVariety
{
    ...
    [SouvenirQuestion("What was the maximum display for the {1}timer in {0}?", ThreeColumns6Answers, "1 1", "2 1", "4 1", "6 1", "1 2", "2 2", "4 2", "1 4", "2 4", Arguments = ["", "ascending ", "descending "], TranslateFormatArgs = [true], ArgumentGroupSize = 1)]
    Timer,
    
    [SouvenirQuestion("What was n for the {1}knob in {0}?", TwoColumns4Answers, Arguments = ["", "colored ", "red ", "black ", "blue ", "yellow "], TranslateFormatArgs = [true], ArgumentGroupSize = 1)]
    [AnswerGenerator.Integers(3, 6)]
    ColoredKnob,
    
    [SouvenirQuestion("What was n for the {1}bulb in {0}?", ThreeColumns6Answers, Arguments = ["", "red ", "yellow "], ArgumentGroupSize = 1, TranslateFormatArgs = [true])]
