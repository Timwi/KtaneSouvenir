...
{
    [Question("Which House was {1} solved\u00a0for in {0}?", TwoColumns4Answers, "Gryffindor", "Hufflepuff", "Slytherin", "Ravenclaw", TranslateAnswers = true, Arguments = ["Binary Puzzle", "Zoni", "Rock-Paper- Scissors-L.-Sp.", "Modules Against Humanity", "Monsplode Trading Cards"], ArgumentGroupSize = 1)]
    House,

    [Question("Which module was solved\u00a0for {1} in {0}?", OneColumn4Answers, ExampleAnswers = ["Binary Puzzle", "Zoni", "Rock-Paper-Scissors-L.-Sp.", "Modules Against Humanity", "Monsplode Trading Cards"], Arguments = ["Gryffindor", "Hufflepuff", "Slytherin", "Ravenclaw"], ArgumentGroupSize = 1, TranslateArguments = [true])]
    Module
}

public partial class SouvenirModule
{
    [Handler("HogwartsModule", "Hogwarts", typeof(SHogwarts), "Timwi")]
    [ManualQuestion("Which House was each module solved for?")]
