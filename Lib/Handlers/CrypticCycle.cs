...
{
    [Question("Which direction was the {1} dial pointing in {0}?", TwoColumns4Answers, AnswerType = InfoType.Sprites, SpriteFieldName = "CycleModuleCrypticSprites", Arguments = [QandA.Ordinal], ArgumentGroupSize = 1)]
    DialDirections,
