...
{
    [Handler("blinkingNotes", "Blinking Notes", typeof(SBlinkingNotes), "Anonymous")]
    [ManualQuestion("What song played?")]
    private IEnumerator<SouvenirInstruction> ProcessBlinkingNotes(ModuleData module)
    {
        ...
        yield return question(SBlinkingNotes.Song).Answers(SBlinkingNotes.Song.GetAnswers()[correct]);
    }
}