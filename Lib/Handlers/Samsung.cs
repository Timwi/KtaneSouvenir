...
{
    [Question("Where was {1} in {0}?", ThreeColumns6Answers, Arguments = ["Duolingo", "Google Maps", "Kindle", "Google Authenticator", "Photomath", "Spotify", "Google Arts & Culture", "Discord"], ArgumentGroupSize = 1, Type = AnswerType.Sprites)]
    AppPositions
}

public partial class SouvenirModule
{
    [Handler("theSamsung", "Samsung", typeof(SSamsung), "TasThiluna", AddThe = true)]
    [ManualQuestion("Where was each app?")]
