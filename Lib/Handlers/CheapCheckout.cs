...
{
    [Question("What was {1} in {0}?", ThreeColumns6Answers, TranslateArguments = [true], Arguments = ["the paid amount", "the first paid amount", "the second paid amount"], ArgumentGroupSize = 1)]
...
{
    [Handler("CheapCheckoutModule", "Cheap Checkout", typeof(SCheapCheckout), "Timwi")]
    [ManualQuestion("What were the paid amounts?")]
