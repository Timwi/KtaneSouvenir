...
{
    [Question("What was played in the {1} stage of {0}?", ThreeColumns6Answers, Type = AnswerType.Audio, ForeignAudioID = "forgetOurVoices", AudioSizeMultiplier = 3, Arguments = [QandA.Ordinal], ArgumentGroupSize = 1)]
    Voice,
