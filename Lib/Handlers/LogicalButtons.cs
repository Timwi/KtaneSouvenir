...
{
    [SouvenirQuestion("What was the color of the {1} button in the {2} stage of {0}?", TwoColumns4Answers, "Red", "Blue", "Green", "Yellow", "Purple", "White", "Orange", "Cyan", "Grey", TranslateAnswers = true, TranslateFormatArgs = [true, false], Arguments = ["top", QandA.Ordinal, "bottom-left", QandA.Ordinal, "bottom-right", QandA.Ordinal, ], ArgumentGroupSize = 2)]
    Color,
    
    [SouvenirQuestion("What was the label on the {1} button in the {2} stage of {0}?", TwoColumns4Answers, "Logic", "Color", "Label", "Button", "Wrong", "Boom", "No", "Wait", "Hmmm", TranslateFormatArgs = [true, false], Arguments = ["top", QandA.Ordinal, "bottom-left", QandA.Ordinal, "bottom-right", QandA.Ordinal, ], ArgumentGroupSize = 2)]
    Label,
