...
{
    [Question("What was the order ID in the {1} order of {0}?", ThreeColumns6Answers, ExampleAnswers = ["3141", "7946", "6905", "6408", "5030", "2803", "6918", "6642", "4645", "4356", "2868", "1887"], Arguments = [QandA.Ordinal], ArgumentGroupSize = 1)]
    [AnswerGenerator.Integers(1000, 9999)]
    Order,

    [Question("What was the product ID in the {1} order of {0}?", ThreeColumns6Answers, ExampleAnswers = ["3141", "7946", "6905", "6408", "5030", "2803", "6918", "6642", "4645", "4356", "2868", "1887"], Arguments = [QandA.Ordinal], ArgumentGroupSize = 1)]
    [AnswerGenerator.Integers(1000, 9999)]
    Product,

    [Question("What was the pallet in the {1} order of {0}?", ThreeColumns6Answers, "CHEP", "SIPPL", "SLPR", "EWHITE", "ECHEP", "ESIPPL", "ESLPR", Arguments = [QandA.Ordinal], ArgumentGroupSize = 1)]
    Pallet
}

public partial class SouvenirModule
{
    [Handler("OrderPickingModule", "Order Picking", typeof(SOrderPicking), "Brawlboxgaming")]
    [ManualQuestion("What were the order ID, product ID and pallet for each order?")]
