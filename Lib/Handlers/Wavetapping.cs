...
{
    [Question("What was the color on the {1} stage in {0}?", TwoColumns4Answers, "Red", "Orange", "Orange-Yellow", "Chartreuse", "Lime", "Green", "Seafoam Green", "Cyan-Green", "Turquoise", "Dark Blue", "Indigo", "Purple", "Purple-Magenta", "Magenta", "Pink", "Grey", TranslateAnswers = true, Arguments = [QandA.Ordinal], ArgumentGroupSize = 1)]
    Colors
}

public partial class SouvenirModule
{
    [Handler("Wavetapping", "Wavetapping", typeof(SWavetapping), "KingSlendy")]
    [ManualQuestion("What was the color in the first two stages?")]
