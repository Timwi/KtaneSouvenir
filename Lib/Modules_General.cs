...
public partial class SouvenirModule
{
    ...
    void Awake()
    {
        _moduleProcessors = new Dictionary<string, (Func<KMBombModule, IEnumerable<object>> processor, string moduleName, string contributor)>()
        {
            ...
            [_ConnectionCheck] = (ProcessConnectionCheck, "Connection Check", "BakersDozenBagels"),
            ...
            [_DoubleArrows] = (ProcessDoubleArrows, "Double Arrows", "BakersDozenBagels"),
            ...
            [_Labyrinth] = (ProcessLabyrinth, "Labyrinth, The", "BakersDozenBagels"),
            ...
            [_NonverbalSimon] = (ProcessNonverbalSimon, "❖", "BakersDozenBagels"),
            ...
            [_SimonSubdivides] = (ProcessSimonSubdivides, "Simon Subdivides", "BakersDozenBagels"),
