...
namespace Souvenir
{
    public class Translation_de : TranslationBase<Translation_de.TranslationInfo_de>
    {
        ...
        protected override Dictionary<Question, TranslationInfo_de> _translations => new()
        {
            ...
            // RPS Judging
            // What did the {1} team throw in the {2} round of {0}?
            // What did the red team throw in the first round of RPS Judging?
            [Question.RPSJudgingThrow] = new()
            {
                NeedsTranslation = true,
                QuestionText = "What did the {1} team throw in the {2} round of {0}?",
                FormatArgs = new Dictionary<string, string>
                {
                    ["red"] = "red",
                    ["blue"] = "blue",
                ...
                TranslatableStrings = new Dictionary<string, string> // See translations.md for more information on this question.
                {
                    ["the RPS Judging where the {0} team threw {1} in the {2} round"] = "the RPS Judging where the {0} team threw {1} in the {2} round",
                    ["dynamite"] = "dynamite",
                    ["tornado"] = "tornado",
                    ["quicksand"] = "quicksand",
                    ["pit"] = "pit",
