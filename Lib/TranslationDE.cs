    ...
    protected override Dictionary<Type, TranslationInfo_de> _translations => new()
    {
        ...
        [typeof(SReorderedKeys)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ...
                ["Where was the pivot in each stage?"] = "Welche Taste war in welcher Stufe das Pivot?",
            },
            Questions = new()
            {
                ...
                [SReorderedKeys.Pivot] = new()
                {
                    ...
                    Question = "Welche Taste war bei {0} in der {1}en Stufe das Pivot?",
                },
            },
        },
        ...
        [typeof(SSwitchingMaze)] = new()
        {
            ...
            {
                ["What was the seed?"] = "Was war der Seedcode?",
                ["What was the starting maze color?"] = "Welche Farbe hatte das Startlabyrinth?",
            },
            Questions = new()
            {
