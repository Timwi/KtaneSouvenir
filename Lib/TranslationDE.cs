...
public class Translation_de : TranslationBase<Translation_de.TranslationInfo_de>
{
    ...
    public override string FormatModuleName(QuestionAttribute qAttr, bool addSolveCount, int numSolved) => addSolveCount
        ? (_translations.Get(qAttr.Handler.EnumType)?.Gender ?? Gender.Neuter) switch
        {
            ...
            Gender.Masculine => $"dem als {ordinal(numSolved)}en gelösten {_translations.Get(qAttr.Handler.EnumType)?.ModuleNameDative ?? _translations.Get(qAttr.Handler.EnumType)?.ModuleName ?? qAttr.Handler.ModuleName}",
            Gender.Neuter => $"dem als {ordinal(numSolved)}es gelösten {_translations.Get(qAttr.Handler.EnumType)?.ModuleNameDative ?? _translations.Get(qAttr.Handler.EnumType)?.ModuleName ?? qAttr.Handler.ModuleName}",
            _ => /* Plural */ $"den als {ordinal(numSolved)}e gelösten {_translations.Get(qAttr.Handler.EnumType)?.ModuleNameDative ?? _translations.Get(qAttr.Handler.EnumType)?.ModuleName ?? qAttr.Handler.ModuleName}",
        }
    ...
    protected override Dictionary<Type, TranslationInfo_de> _translations => new()
    {
        ...
        [typeof(S0)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the starting number?"] = "Wie lautete die Startzahl?",
            },
            Questions = new()
            {
                [S0.QNumber] = new()
        ...
        [typeof(S1000Words)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the words shown?"] = "Welche Wörter kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(S3DMaze)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the markings?"] = "Was waren die Markierungen?",
                ["What was the cardinal direction?"] = "Was war die Himmelsrichtung?",
            },
            Questions = new()
            {
        ...
        [typeof(S3DTunnels)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the goal symbols?"] = "Welche Symbole waren die Ziele?",
            },
            Questions = new()
            {
        ...
        [typeof(S3NPlus1)] = new()
        {
            ManualQuestions = new()
            {
                ["What number was initially displayed?"] = "Welche Zahl war am Anfang auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(S7)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the LED colors for each stage?"] = "Welche Farbe hatten die LEDs in welcher Stufe?",
                ["What was each channel’s initial value?"] = "Was waren die Anfangswerte Farbkanäle?",
            },
            Questions = new()
            {
        ...
        [typeof(S9Ball)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the numbers on each ball?"] = "Welche Zahlen waren auf den Kugeln?",
            },
            Questions = new()
            {
        ...
        [typeof(SAccumulation)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the background colors at each stage?"] = "Welche Stufe hatte welche Hintergrundfarbe?",
                ["What was the border color?"] = "Was war die Rahmenfarbe?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Adventure-Spiel",
            ManualQuestions = new()
            {
                ["Which items were present?"] = "Welche Gegenstände kamen vor?",
            },
            Questions = new()
            {
                [SAdventureGame.QPresentItem] = new()
                {
                    ...
                    Question = "Welcher Gegenstand kam bei {0} vor?",
                },
            },
            Discriminators = new()
            {
                [SAdventureGame.DPresentItem] = new()
                {
                    ...
                    Discriminator = "das Adventure-Spiel, bei dem {0} vorkam,",
                },
            },
        },
        ...
        [typeof(SAffineCycle)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which direction were the dials pointing?"] = "In welche Richtung zeigten die Drehknöpfe?",
                ["What was written on each dial?"] = "Was stand auf den Drehknöpfen?",
            },
            Questions = new()
            {
        ...
        [typeof(SAlcoholicRampage)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which mercenaries were displayed?"] = "Welche Söldner wurden angezeigt?",
            },
            Questions = new()
            {
        ...
        [typeof(SAlgebra)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the first two equations?"] = "Was waren die ersten zwei Gleichungen?",
            },
            Questions = new()
            {
        ...
        [typeof(SAlgorithmia)] = new()
        {
            ManualQuestions = new()
            {
                ...
                ["What color was the bulb?"] = "Welche Farbe hatte die Glühlampe?",
                ["Which numbers were present in the seed?"] = "Welche Zahlen kamen im Seedcode vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SAlphabeticalRuling)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the letters and numbers displayed in each stage?"] = "Welche Buchstaben und Ziffern kamen in welcher Stufe vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SAlphabetNumbers)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the numbers on the buttons in each stage?"] = "Welche Zahlen waren in welcher Stufe auf den Tasten?",
            },
            Questions = new()
            {
        ...
        [typeof(SAlphabetTiles)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the letters shown during each cycle?"] = "Welche Buchstaben kamen in welchem Zyklus vor?",
                ["What was the missing letter?"] = "Welcher Buchstabe hat gefehlt?",
            },
            Questions = new()
            {
        ...
        [typeof(SAlphaBits)] = new()
        {
            ...
            Questions = new()
            {
                [SAlphaBits.DisplayedCharacters] = new()
                {
                    ...
                    Question = "Welches Zeichen war bei {0} auf dem {1} Display?",
                    Arguments = new()
                    {
            ...
            Discriminators = new()
            {
                [SAlphaBits.Discriminator] = new()
                {
                    ...
                    Discriminator = "dem Alpha-Bits, bei dem dieses Zeichen {0} erschien,",
                    Arguments = new()
                    {
                        ["top-left"] = "oben links",
        ...
        [typeof(SAMessage)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the received message?"] = "Was war die Anfangsnachricht?",
            },
            Questions = new()
            {
        ...
        [typeof(SAmusementParks)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which rides were available?"] = "Welche Attraktionen standen zur Auswahl?",
            },
            Questions = new()
            {
        ...
        [typeof(SAngelHernandez)] = new()
        {
            ManualQuestions = new()
            {
                ["What letter was shown by the raised buttons in each stage?"] = "Welche Buchstaben wurden in welcher Stufe durch die erhöhten Tasten angedeutet?",
            },
            Questions = new()
            {
        ...
        [typeof(SArena)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ...
                ["What enemies were present in the defend phase?"] = "Welche Gegner kamen in der Verteidigungsphase vor?",
                ["What numbers were present in the grab phase?"] = "Welche Zahlen kamen in der Greifphase vor?",
            },
            Questions = new()
            {
                [SArena.QDamage] = new()
        ...
        [typeof(SASCIIMaze)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What characters were displayed?"] = "Welche Zeichen kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SAzureButton)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ...
                ["What was M?"] = "Was war M?",
                ["What were the arrows?"] = "Welche Pfeile kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SBakery)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which menu items were present?"] = "Was stand auf dem Menü?",
            },
            Questions = new()
            {
                [SBakery.Items] = new()
        ...
        [typeof(SBamboozledAgain)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the initial labels and colors of each button?"] = "Welche Farben und Aufschriften hatten die Tasten am Anfang?",
                ["What were the decrypted text and color of each displayed message?"] = "Welche Farben und Dekodierergebnisse hatten die Anzeigen auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SBamboozlingButton)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What color was the button in each stage?"] = "Welche Farbe hatte die Taste in welcher Stufe?",
                ["What were the labels on the button in each stage?"] = "Welche Aufschrift hatte die Taste in welcher Stufe?",
                ["What were the displays and their colors in each stage?"] = "Was wurde in welcher Stufe auf dem Display angezeigt und in welcher Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SBarCharts)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the bars’ heights, colors, and labels?"] = "Welche Höhe, Farbe und Beschriftung hatten die Balken?",
                ["What was the category?"] = "Was war die Kategorie?",
                ["What was the unit?"] = "Was war die Einheit?",
            },
            Questions = new()
            {
        ...
        [typeof(SBarcodeCipher)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the screen number?"] = "Welche Zahl war auf dem Display?",
                ["What was the edgework represented by each barcode?"] = "Welche Peripherie-Info wurde durch welchen Barcode erfragt?",
                ["What was the answer for each barcode?"] = "Welcher Barcode ergab welche Lösung?",
            },
            Questions = new()
            {
        ...
        [typeof(SBartending)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which ingredient was in which position?"] = "Welche Zutat war an welcher Stelle?",
            },
            Questions = new()
            {
        ...
        [typeof(SBigBean)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What color and wobbliness was the bean?"] = "Welche Farbe und Wackeligkeit hatte die Bohne?",
            },
            Questions = new()
            {
                [SBigBean.Color] = new()
        ...
        [typeof(SBigCircle)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which direction was the circle spinning?"] = "Wierum hat sich der Kreis gedreht?",
            },
            Questions = new()
            {
                [SBigCircle.SpinDirection] = new()
                {
                    ...
                    Question = "Wierum hat sich bei {0} der Kreis gedreht?",
                    Answers = new()
                    {
        ...
        {
            ModuleName = "Binär-Shift",
            ManualQuestions = new()
            {
                ["What were the initial numbers?"] = "Was waren die Zahlen am Anfang?",
                ["What number was selected at each stage?"] = "Welche Zahl wurde in welchem Schritt ausgewählt?",
            },
            Questions = new()
            {
        ...
        [typeof(SBitmaps)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["How many pixels were black/white in each quadrant?"] = "Wie viele Pixel waren in welchem Quadranten schwarz bzw. weiß?",
            },
            Questions = new()
            {
        ...
        [typeof(SBlindfoldedYahtzee)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which rolls did the module claim?"] = "Welche Würfelergebnisse hat das Modul behauptet?",
            },
            Questions = new()
            {
        ...
        [typeof(SBlinkingNotes)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What song played?"] = "Welches Lied war zu hören?",
            },
            Questions = new()
            {
        ...
        [typeof(SBlinkstop)] = new()
        {
            ManualQuestions = new()
            {
                ["How many times did the LED flash?"] = "Wie oft hat die LED geblinkt?",
                ["Which color did the LED flash the least?"] = "Welche Farbe hat die LED am wenigsten geblinkt?",
            },
            Questions = new()
            {
        ...
        [typeof(SBlockbusters)] = new()
        {
            ManualQuestions = new()
            {
                ["What letters were in the leftmost column at the start?"] = "Welche Buchstaben waren am Anfang in der Spalte am linken Rand?",
            },
            Questions = new()
            {
        ...
        [typeof(SBlueArrows)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the characters on the screen?"] = "Welche Zeichen waren auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SBobBarks)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the indicator labels?"] = "Welcome Aufschrift hatten die Indikatoren?",
                ["Which buttons flashed in sequence?"] = "Welche Tasten haben nacheinander geleuchtet?",
            },
            Questions = new()
            {
        ...
        [typeof(SBoggle)] = new()
        {
            ManualQuestions = new()
            {
                ["Which letters were initially visible?"] = "Welche Buchstaben waren am Anfang sichtbar?",
            },
            Questions = new()
            {
                [SBoggle.Letters] = new()
        ...
        [typeof(SBoneAppleTea)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the phrases?"] = "Welche Phrasen kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SBookOfMario)] = new()
        {
            ManualQuestions = new()
            {
                ["Who said something in each stage?"] = "Wer hat in welcher Stufe was gesagt?",
                ["What was each character’s quote?"] = "Was war das Zitat welcher Figur?",
            },
            Questions = new()
            {
        ...
        [typeof(SBoomtarTheGreat)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the first and second rules?"] = "Was waren die erste und zweite Regel?",
            },
            Questions = new()
            {
        ...
        [typeof(SBorderedKeys)] = new()
        {
            ...
            Questions = new()
            {
                [SBorderedKeys.BorderColor] = new()
                {
                    ...
                    Question = "Was war beim Druck auf diesen Knopf bei {0} die Randfarbe?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Green"] = "Grün",
                ...
                [SBorderedKeys.Digit] = new()
                {
                    ...
                    Question = "Was war beim Druck auf diesen Knopf bei {0} die angezeigte Ziffer?",
                },
                [SBorderedKeys.KeyColor] = new()
                {
                    // English: What was this key’s key color when it was pressed in {0}? (+ extra)
                    Question = "Was war beim Druck auf diesen Knopf bei {0} die Knopffarbe?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Green"] = "Grün",
                ...
                [SBorderedKeys.Label] = new()
                {
                    ...
                    Question = "Was war beim Druck auf diesen Knopf bei {0} die Aufschrift?",
                },
                [SBorderedKeys.LabelColor] = new()
                {
                    // English: What was this key’s label color when it was pressed in {0}? (+ extra)
                    Question = "Was war beim Druck auf diesen Knopf bei {0} die Aufschriftfarbe?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Green"] = "Grün",
        ...
        [typeof(SBottomGear)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the initially shown tweet?"] = "Welcher Tweet war am Anfang zu sehen?",
            },
            Questions = new()
            {
        ...
        [typeof(SBraille)] = new()
        {
            ManualQuestions = new()
            {
                ["Which Braille patterns were present?"] = "Welche Braille-Muster kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SBreakfastEgg)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which colors appeared on the egg?"] = "Welche Farben waren auf dem Ei?",
            },
            Questions = new()
            {
        ...
        [typeof(SBrokenGuitarChords)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the displayed chord?"] = "Welcher Akkord war auf dem Display?",
                ["Which string was broken?"] = "Welche Saite war kaputt?",
            },
            Questions = new()
            {
        ...
        [typeof(SBurgerAlarm)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the displayed digits?"] = "Welche Ziffern waren auf dem Display?",
                ["What were the order numbers?"] = "Was waren die Bestellnummern?",
            },
            Questions = new()
            {
        ...
        [typeof(SButtonage)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["How many of each color and border color were there?"] = "Welche Farbe und Rahmenfarbe kam wie oft vor?",
                ["How many special buttons were there?"] = "Wie viele Spezialtasten gab es?",
                ["How many buttons had a P?"] = "Wie viele Tasten hatten ein P?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Tastenfolgen",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["How many times did each color occur?"] = "Welche Farbe kam wie oft vor?",
            },
            Questions = new()
            {
                [SButtonSequence.QColorOccurrences] = new()
                {
                    ...
                    Question = "Wie viele der Tasten bei {0} waren {1}?",
                    Arguments = new()
                    {
                        ["red"] = "rot",
                        ["blue"] = "blau",
            ...
            Discriminators = new()
            {
                [SButtonSequence.DColorOccurrences] = new()
                {
                    ...
                    Discriminator = "der Tastenfolge mit {0} {1}",
                    Arguments = new()
                    {
                        ["red button"] = "roten Taste",
                        ["blue button"] = "blauen Taste",
                        ["yellow button"] = "gelben Taste",
                        ["white button"] = "weißen Taste",
                        ["red buttons"] = "roten Tasten",
                        ["blue buttons"] = "blauen Tasten",
                        ["yellow buttons"] = "gelben Tasten",
                        ["white buttons"] = "weißen Tasten",
                    },
                },
            },
        },
        ...
        [typeof(SCactisConundrum)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What colors was the LED?"] = "Welche Farben hatte die LED?",
            },
            Questions = new()
            {
        ...
        [typeof(SCaesarPsycho)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What text and color were on the top display in each stage?"] = "Was stand in welcher Stufe auf dem oberen Display, und in welcher Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SCalendar)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the holiday?"] = "Um welchen Feiertag ging es?",
            },
            Questions = new()
            {
        ...
        [typeof(SCARPS)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the starting colors?"] = "Was waren die Farben am Anfang?",
            },
            Questions = new()
            {
                [SCARPS.Cell] = new()
        ...
        [typeof(SCartinese)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What lyrics were played by each button?"] = "Welcher Songtext wurde durch welche Taste abgespielt?",
                ["What color was each button?"] = "Welche Taste hatte welche Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SCatchphrase)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the colours of the panels?"] = "Welche Blende hatte welche Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SCharacterCodes)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the characters?"] = "Welche Zeichen kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SCharacterShift)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the characters on the sliders?"] = "Welche Zeichen gab es bei welchem Schieberegler zur Auswahl?",
            },
            Questions = new()
            {
        ...
        [typeof(SCharacterSlots)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Who was displayed in each slot for each stage?"] = "Wer war in welcher Stufe in welchem Fensterchen zu sehen?",
            },
            Questions = new()
            {
        ...
        [typeof(SCheapCheckout)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the paid amounts?"] = "Welche Beträge wurden angeboten?",
            },
            Questions = new()
            {
        ...
        [typeof(SChess)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the coordinates?"] = "Welche Koordinaten kamen vor?",
            },
            Questions = new()
            {
            ...
            Discriminators = new()
            {
                [SChess.DCoordinate] = new()
                {
                    ...
                    Discriminator = "dem Schach, dessen {1}e Koordinate {0} war, ",
                },
            },
        },
        ...
        [typeof(SChineseCounting)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What colors were the LEDs?"] = "Welche Farbe hatten die LEDs?",
            },
            Questions = new()
            {
        ...
        [typeof(SChineseRemainderTheorem)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the equations?"] = "Wie lauteten die Gleichungen?",
            },
            Questions = new()
            {
        ...
        [typeof(SChordQualities)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What notes were in the given chord?"] = "Welche Noten kamen im vorgegebenen Akkord vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SClockCounter)] = new()
        {
            ManualQuestions = new()
            {
                ["Which arrows were shown?"] = "Welche Pfeile kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SCoffeeBeans)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the movements?"] = "Welche Bewegungen kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SCoffeebucks)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the last customer’s preferred sugar content, time of day, stress level, and size?"] = "Was war beim letzten Kunden der bevorzugte Zuckergehalt, die Tageszeit, das Stressniveau und die Größe?",
            },
            Questions = new()
            {
                [SCoffeebucks.Sugar] = new()
                {
                    ...
                    Question = "Was war bei {0} beim letzten Kunden der bevorzugte Zuckergehalt?",
                },
                [SCoffeebucks.Time] = new()
                {
                    // English: What was the last customer’s preferred time of day in {0}?
                    Question = "Was war bei {0} beim letzten Kunden die bevorzugte Tageszeit?",
                },
                [SCoffeebucks.Stress] = new()
                {
                    // English: What was the last customer’s preferred stress level in {0}?
                    Question = "Was war bei {0} beim letzten Kunden das bevorzugte Stressniveau?",
                },
        ...
        [typeof(SColorAddition)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the three numbers?"] = "Was waren die drei Zahlen?",
            },
            Questions = new()
            {
        ...
        [typeof(SColorBraille)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What color was each dot?"] = "Welche Farbe hatten die Punkte?",
            },
            Questions = new()
            {
        ...
        [typeof(SColorDecoding)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the indicator patterns and colors in each stage?"] = "Welche Muster und Farben hatten die Indikatoren in welcher Stufe?",
            },
            Questions = new()
            {
        ...
        [typeof(SColoredKeys)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the displayed word and its color?"] = "Welches Wort war auf dem Display und in welcher Farbe?",
                ["What were the colors and letters on each key?"] = "Welche Farben und Buchstaben waren auf den Tasten?",
            },
            Questions = new()
            {
        ...
        [typeof(SColoredSquares)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the first color group?"] = "Welche Farbe hatte die erste Eingabe?",
            },
            Questions = new()
            {
        ...
        [typeof(SColoredSwitches)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the initial position of the switches?"] = "Wie standen die Schalter am Anfang?",
            },
            Questions = new()
            {
        ...
        [typeof(SColorMorse)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the colors of the LEDs?"] = "Welche Farbe hatten die LEDs?",
                ["What characters were flashed by the LEDs?"] = "Welche Zeichen wurden über die LEDs geblinkt?",
            },
            Questions = new()
            {
        ...
        [typeof(SColorsMaximization)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["How many buttons were there of each color?"] = "Wie viele Tasten gab es in welcher Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SColouredCubes)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the colours of the cubes and stage lights in each stage?"] = "In welcher Stufe hatte der Würfel und der Stufenanzeiger welche Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SColouredCylinder)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What colours did the cylinder flash?"] = "In welcher Farbe blinkten die Zylinder?",
            },
            Questions = new()
            {
        ...
        [typeof(SColourFlash)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the color of the last word in the sequence?"] = "Welche Farbe hatte das letzte Wort in der Sequenz?",
            },
            Questions = new()
            {
        ...
        [typeof(SConcentration)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the initial layout?"] = "Wie war das Arrangement am Anfang?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Bedingte Tasten",
            ModuleNameDative = "Bedingten Tasten",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What was the color of each button?"] = "Welche Taste hatte welche Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SConnectedMonitors)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What numbers were initially displayed?"] = "Welche Zahlen waren am Anfang auf den Monitoren?",
                ["What colors were the indicators?"] = "Welche Farbe hatten die Indikatoren?",
            },
            Questions = new()
            {
                [SConnectedMonitors.Number] = new()
                {
                    ...
                    Question = "Welche Zahl war bei {0} anfänglich auf diesem Monitor zu sehen?",
                },
                [SConnectedMonitors.SingleIndicator] = new()
                {
                    // English: What colour was the indicator on this screen in {0}? (+ extra)
                    Question = "Welche Farbe hatte bei {0} der Indikator auf diesem Monitor?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Orange"] = "Orange",
                ...
                [SConnectedMonitors.OrdinalIndicator] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} der {1}e Indikator auf diesem Monitor?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Orange"] = "Orange",
        ...
        [typeof(SCoordinates)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the grid size?"] = "Was war die Rastergröße?",
            },
            Questions = new()
            {
        ...
        [typeof(SCoordination)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the label and position of the starting coordinate?"] = "Welche Aufschrift und Position hatte die Startkoordinate?",
            },
            Questions = new()
            {
                [SCoordination.Label] = new()
                {
                    ...
                    Question = "Welche Aufschrift hatte bei {0} die Startkoordinate?",
                },
        ...
        [typeof(SCorners)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the colors of the corners?"] = "Welche Farbe hatten die Ecken?",
            },
            Questions = new()
            {
                [SCorners.Colors] = new()
        ...
        [typeof(SCrazyHamburger)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the displayed ingredients?"] = "Welche Zutaten wurden angezeigt?",
            },
            Questions = new()
            {
        ...
        [typeof(SCreation)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the weather condition on the first day?"] = "Wie war das Wetter am ersten Tag?",
            },
            Questions = new()
            {
        ...
        [typeof(SCritters)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the color?"] = "Welche Farbe kam vor?",
            },
            Questions = new()
            {
                [SCritters.Color] = new()
                {
                    ...
                    Question = "Welche Farbe kam bei {0} vor?",
                    Answers = new()
                    {
                        ["Yellow"] = "Gelb",
                        ["Pink"] = "Pink",
        ...
        [typeof(SCruelKeypads)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What symbols were on the keys in each stage?"] = "Welche Symbole waren in welcher Stufe auf welcher Taste?",
                ["What was the color of the bar in each stage?"] = "In welcher Stufe hatte der Balken welche Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SCrypticKeypad)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the labels and cardinal directions of each key?"] = "Welche Aufschrift und Himmelsrichtung war auf den Tasten?",
            },
            Questions = new()
            {
        ...
        [typeof(SCursedDoubleOh)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the first digit of the initial number?"] = "Was war bei der Anfangszahl die erste Ziffer?",
            },
            Questions = new()
            {
        ...
        [typeof(SCustomerIdentification)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which customers were displayed?"] = "Welche Kunden kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SCyanButton)] = new()
        {
            ...
            Discriminators = new()
            {
                [SCyanButton.DPositions] = new()
                {
                    ...
                    Discriminator = "dem Türkisen Knopf, bei dem der Knopf in der {0}en Stufe {1} war,",
                    Arguments = new()
                    {
                        ["top left"] = "oben links",
        ...
        [typeof(SDACHMaze)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which region did you depart from?"] = "In welcher Region ging es los?",
            },
            Questions = new()
            {
        ...
        [typeof(SDeafAlley)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the shape generated?"] = "Welche Form wurde generiert?",
            },
            Questions = new()
            {
        ...
        [typeof(SDecolourFlash)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the words and colours of each goal?"] = "Welches Ziel hatte welches Wort und welche Farbe?",
            },
            Questions = new()
            {
            ...
            Discriminators = new()
            {
                [SDecolourFlash.DGoal] = new()
                {
                    ...
                    Discriminator = "der Entfärbten Folge, deren {0} vom {1}en Ziel {2} war, ",
                    Arguments = new()
                    {
                        ["word"] = "Wort",
                        ["colour"] = "Farbe",
        ...
        [typeof(SDenialDisplays)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was initially on the displays?"] = "Was war am Anfang auf den Displays?",
            },
            Questions = new()
            {
            ...
            Discriminators = new()
            {
                [SDenialDisplays.DDisplays] = new()
                {
                    ...
                    Discriminator = "den Dementi-Displays, auf deren Display {1} am Anfang {0} stand,",
                },
            },
        },
        ...
        [typeof(SDetoNATO)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the displayed word for each stage?"] = "Was war in welcher Stufe auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SDevilishEggs)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ...
                ["What were the numbers and letters shown on the prism?"] = "Welche Zahlen und Buchstaben kamen auf dem Prisma vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SDigisibility)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the numbers on the buttons?"] = "Welche Zahlen waren auf den Tasten?",
            },
            Questions = new()
            {
        ...
        [typeof(SDigitString)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the displayed digit string?"] = "Wie lautete die Ziffernfolge auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SDimensionDisruption)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the visible characters?"] = "Welche Zeichen waren sichtbar?",
            },
            Questions = new()
            {
            ...
            Discriminators = new()
            {
                [SDimensionDisruption.DVisibleLetters] = new()
                {
                    ...
                    Discriminator = "der Dimensionsspaltung, bei der {0} als Zeichen sichtbar war,",
                },
            },
        },
        ...
        [typeof(SDirectionalButton)] = new()
        {
            ...
            Questions = new()
            {
                [SDirectionalButton.Color] = new()
                {
                    ...
                    Question = "Welche Farbe hatte der Knopf bei {0} in der {1}en Stufe?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Blue"] = "Blau",
                ...
                [SDirectionalButton.Label] = new()
                {
                    ...
                    Question = "Was stand bei {0} in der {1}en Stufe auf dem Knopf?",
                },
            },
        },
        ...
        [typeof(SDiscoloredSquares)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the remembered position for each color?"] = "Welche Position wurde für welche Farbe vermerkt?",
            },
            Questions = new()
            {
        ...
        [typeof(SDisorderedKeys)] = new()
        {
            ...
            Questions = new()
            {
                [SDisorderedKeys.MissingInfo] = new()
                {
                    ...
                    Question = "Welche Information fehlte bei {0} auf diesem Knopf?",
                    Answers = new()
                    {
                ...
                [SDisorderedKeys.UnrevealedKeyColor] = new()
                {
                    ...
                    Question = "Was war bei {0} die unaufgedeckte Knopffarbe dieses Knopfes?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Green"] = "Grün",
                ...
                [SDisorderedKeys.UnrevealedLabelColor] = new()
                {
                    ...
                    Question = "Was war bei {0} die unaufgedeckte Aufschriftfarbe dieses Knopfes?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Green"] = "Grün",
                ...
                [SDisorderedKeys.UnrevealedKeyLabel] = new()
                {
                    ...
                    Question = "Was war bei {0} die unaufgedeckte Aufschrift dieses Knopfes?",
                },
                [SDisorderedKeys.RevealedKeyColor] = new()
                {
                    // English: What was the revealed key color for this key in {0}? (+ extra)
                    Question = "Was war bei {0} die aufgedeckte Knopffarbe dieses Knopfes?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Green"] = "Grün",
                ...
                [SDisorderedKeys.RevealedLabelColor] = new()
                {
                    ...
                    Question = "Was war bei {0} die aufgedeckte Aufschriftfarbe dieses Knopfes?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Green"] = "Grün",
                ...
                [SDisorderedKeys.RevealedLabel] = new()
                {
                    ...
                    Question = "Was war bei {0} die aufgedeckte Aufschrift dieses Knopfes?",
                },
            },
        },
        ...
        [typeof(SDividedSquares)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What color was shown when the correct square was pressed?"] = "Welche Farbe erschien, als das korrekte Quadrat betätigt wurde?",
            },
            Questions = new()
            {
        ...
        [typeof(SDNAMutation)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the DNA strands’ colors?"] = "Welche Farbe hatten die DNA-Stränge?",
                ["What were the given nucleotides’ letters and colors?"] = "Welche Buchstaben und Farben hatten die vorgegebenen Nukleotide?",
            },
            Questions = new()
            {
        ...
        [typeof(SDoofenshmirtzEvilInc)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What jingles played?"] = "Welcher Jingle war zu hören?",
                ["What images were shown?"] = "Welche Bilder waren zu sehen?",
            },
            Questions = new()
            {
        ...
        [typeof(SDoubleColor)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the screen color in each stage?"] = "Welche Farbe hatte das Display in welcher Stufe?",
            },
            Questions = new()
            {
        ...
        [typeof(SDoubleDigits)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the numbers on the displays?"] = "Welche Zahlen waren auf den Displays?",
            },
            Questions = new()
            {
        ...
        [typeof(SDoubleExpert)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the starting key number?"] = "Was war die anfängliche Schlüsselzahl?",
            },
            Questions = new()
            {
        ...
        [typeof(SDoubleListening)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What sounds played?"] = "Welche Sounds waren zu hören?",
            },
            Questions = new()
            {
        ...
        [typeof(SDoubleScreen)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What colors were the screens in each stage?"] = "Welche Farbe hatte welches Display in welcher Stufe?",
            },
            Questions = new()
            {
                [SDoubleScreen.Colors] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} das {1} Display in der {2}en Stufe?",
                    Arguments = new()
                    {
                        ["top"] = "oberen",
                        ["bottom"] = "unteren",
        ...
        [typeof(SDrDoctor)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which diseases and symptoms were listed?"] = "Welche Krankheiten und Symptome kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SDumbWaiters)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which players were present?"] = "Welche Spieler waren vorhanden?",
            },
            Questions = new()
            {
        ...
        [typeof(SEarthbound)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the background?"] = "Was war der Hintergrund?",
                ["Which monster was shown?"] = "Welches Monster war zu sehen?",
            },
            Questions = new()
            {
        ...
        [typeof(SEmoji)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the emoji?"] = "Welche Emojis kamen vor?",
            },
            Questions = new()
            {
                [SEmoji.Emoji] = new()
        ...
        [typeof(SEnaCipher)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the keyword, the transposition key and the encrypted word?"] = "Was war das Schlüsselwort, der Umstellungsschlüssel und das verschlüsselte Wort?",
            },
            Questions = new()
            {
        ...
        [typeof(SEncryptedDice)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which numbers were rolled in each stage?"] = "Was wurde in welcher Stufe gewürfelt?",
            },
            Questions = new()
            {
        ...
        [typeof(SEncryptedEquations)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the main shapes of the three operands?"] = "Welche Formen entsprachen den drei Operanden?",
            },
            Questions = new()
            {
        ...
        [typeof(SEncryptedMaze)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which symbol was spinning which way?"] = "Welches Symbol hat sich wierum gedreht?",
            },
            Questions = new()
            {
        ...
        [typeof(SEncryptedMorse)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the received key?"] = "Welcher Schlüssel wurde empfangen?",
            },
            Questions = new()
            {
                [SEncryptedMorse.Key] = new()
                {
                    ...
                    Question = "Welcher Schlüssel wurde bei {0} empfangen?",
                },
            },
        },
        ...
        [typeof(SEncryptionBingo)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the first encoding used?"] = "Welche Kodierung kam als erste zum Einsatz?",
            },
            Questions = new()
            {
        ...
        [typeof(SEnglishEntries)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the displayed quote?"] = "Welches Zitat war auf dem Fernseher?",
            },
            Questions = new()
            {
        ...
        [typeof(SEntryNumberFour)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the numbers shown?"] = "Welche Zahlen waren auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SEquationsX)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the displayed symbol?"] = "Welches Symbol war auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SErrorCodes)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the active error code?"] = "Welcher Fehlercode war aktiv?",
            },
            Questions = new()
            {
        ...
        [typeof(SFactoryMaze)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What room did you start in?"] = "In welchem Raum ging es los?",
            },
            Questions = new()
            {
        ...
        [typeof(SFastMath)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the last pair of letters?"] = "Was war das letzte Buchstabenpaar?",
            },
            Questions = new()
            {
        ...
        [typeof(SFaultyButtons)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which button did each button refer to?"] = "Welche Taste bezog sich auf welche?",
            },
            Questions = new()
            {
        ...
        [typeof(SFaultyRGBMaze)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Where were the exit and keys of the maze?"] = "Wo im Labyrinth waren der Ausgang und die Schlüssel?",
                ["What was the maze number for each maze?"] = "Welches Labyrinth hatte welche Nummer?",
            },
            Questions = new()
            {
        ...
        [typeof(SFindTheDate)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the day, month, and year for each stage?"] = "Welcher Tag, Monat und Jahr kam in welcher Stufe vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SFiveLetterWords)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the displayed words?"] = "Welche Wörter waren auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SFizzBuzz)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the displayed numbers?"] = "Welche Zahlen waren auf den Displays?",
            },
            Questions = new()
            {
        ...
        [typeof(SFlags)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the country flags, the main flag, and the displayed number?"] = "Welche Flaggen waren vorhanden, was war die Hauptflagge und die Ziffer auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SFlashingArrows)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the number shown on the display?"] = "Welche Zahl war auf dem Display?",
                ["What were the relevant arrow’s colors?"] = "Welche Farbe hatten die maßgeblichen Pfeile?",
            },
            Questions = new()
            {
                ...
                [SFlashingArrows.ReferredArrow] = new()
                {
                    ...
                    Question = "Welche Farbe kam bei {0} {1} Schwarz auf dem maßgeblichen Pfeil?",
                    Arguments = new()
                    {
                        ["before"] = "vor",
                        ["after"] = "nach",
        ...
        [typeof(SFlashingLights)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["How many times did each LED flash each color?"] = "Welche LED hat wie oft in welcher Farbe geblinkt?",
            },
            Questions = new()
            {
        ...
        [typeof(SFlavorTextEX)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which module’s flavor text was presented in each stage?"] = "Der Würztext welches Moduls kamen in welcher Stufe vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SFlyswatting)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which flies were present, but not in the solution?"] = "Welche Fliegen waren vorhanden aber nicht Teil der Lösung?",
            },
            Questions = new()
            {
        ...
        [typeof(SForgetAnyColor)] = new()
        {
            ...
            Discriminators = new()
            {
                ...
                [SForgetAnyColor.DGearColor] = new()
                {
        ...
        [typeof(SForgetEverything)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the displayed digits in stage one?"] = "Welche Ziffern waren in Stufe 1 auf dem Zylinder?",
            },
            Questions = new()
            {
        ...
        [typeof(SForgetMe)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What numbers were in which positions in the initial puzzle?"] = "Welche Zahlen waren am Anfang an welcher Position?",
            },
            Questions = new()
            {
        ...
        [typeof(SForgetMeNot)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the displayed digits in each stage?"] = "Welche Ziffer war in welcher Stufe auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SForgetOurVoices)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was said by whom each stage?"] = "Wer hat in welcher Stufe was gesagt?",
            },
            Questions = new()
            {
        ...
        [typeof(SForgetThis)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the displayed character in each stage?"] = "Welches Zeichen war in welcher Stufe auf dem Display?",
                ["What was the LED color in each stage?"] = "Welche Farbe hatte die LED in welcher Stufe?",
            },
            Questions = new()
            {
                ...
                [SForgetThis.QDigits] = new()
                {
                    ...
                    Question = "Welche Ziffer war bei {0} in der {1}en Stufe auf dem Display?",
                },
            },
            Discriminators = new()
            {
        ...
        [typeof(SFreeParking)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the player token?"] = "Welcher Spielstein kam vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SFunctions)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the last digit of the first query result?"] = "Was war die letzte Ziffer des ersten Anfrageergebnisses?",
                ["What were the numbers and letter shown at the bottom?"] = "Welche Zahlen und welcher Buchstabe standen unten?",
            },
            Questions = new()
            {
                ...
                [SFunctions.LeftNumber] = new()
                {
                    ...
                    Question = "Welche Zahl war bei {0} links vom Buchstaben?",
                },
                ...
                [SFunctions.RightNumber] = new()
                {
                    ...
                    Question = "Welche Zahl war bei {0} rechts vom Buchstaben?",
                },
            },
        },
        ...
        [typeof(SGadgetronVendor)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the displayed weapons?"] = "Welche Waffen wurden angezeigt?",
            },
            Questions = new()
            {
        ...
        [typeof(SGameOfLifeCruel)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which color combinations occurred?"] = "Welche Farbkombinationen kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SGarfieldKart)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the name of the track?"] = "Welchen Namen hatte die Rennstrecke?",
                ["How many puzzle pieces were there?"] = "Wie viele Puzzleteile waren zu sehen?",
            },
            Questions = new()
            {
        ...
        [typeof(SGhostMovement)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Where were Pac-Man and the ghosts?"] = "Wo waren Pac-Man und die Geister?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Riesen-Geheimschrift",
            Gender = Gender.Feminine,
            ManualQuestions = new()
            {
                ["What was the displayed keyword?"] = "Welches Schlüsselwort war auf dem Display?",
            },
            Questions = new()
            {
                [SGiantsCipher.Keywords] = new()
                {
                    ...
                    Question = "Welches Schlüsselwort war bei {0} auf dem Display?",
                },
            },
        },
        ...
        [typeof(SGirlfriend)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the chosen language?"] = "Welche Sprache war ausgewählt?",
            },
            Questions = new()
            {
        ...
        [typeof(SGoofysGame)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What numbers were shown in Morse code?"] = "Welche Zahlen wurden als Morsezeichen übermittelt?",
            },
            Questions = new()
            {
        ...
        [typeof(SGrandPiano)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the given notes?"] = "Welche Noten waren vorgegeben?",
            },
            Questions = new()
            {
                [SGrandPiano.Key] = new()
        ...
        [typeof(SGreenArrows)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the last number on the display?"] = "Was war die letzte Zahl auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SGridlock)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the starting color?"] = "Was war die Startfarbe?",
                ["What was the starting position?"] = "Wo war die Startposition?",
            },
            Questions = new()
            {
        ...
        [typeof(SGroceryStore)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the first item shown?"] = "Welcher Artikel wurde zuerst angezeigt?",
            },
            Questions = new()
            {
        ...
        [typeof(SGryphons)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the gryphon’s name and age?"] = "Welchen Namen und welches Alter hatte der Greif?",
            },
            Questions = new()
            {
                [SGryphons.Name] = new()
        ...
        [typeof(SGuessWho)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which colors flashed “YES”?"] = "In welchen Farben erschien „YES“?",
            },
            Questions = new()
            {
        ...
        [typeof(SGyromaze)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the LED colors?"] = "Welche LED hatte welche Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SHalliGalli)] = new()
        {
            ManualQuestions = new()
            {
                ["Which fruit were there five of?"] = "Von welcher Frucht gab es fünf?",
                ["What were the relevant counts?"] = "Was waren die maßgeblichen Anzahlen?",
            },
            Questions = new()
            {
                ...
                [SHalliGalli.Counts] = new()
                {
                    ...
                    Question = "Was waren die maßgeblichen Anzahlen bei {0}?",
                },
            },
        },
        ...
        [typeof(SHereditaryBaseNotation)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the number on the bottom display?"] = "Welche Zahl war auf dem unteren Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SHexabutton)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ...
                ["What Morse Code letter was transmitted?"] = "Welcher Buchstabe wurde als Morsezeichen übermittelt?",
            },
            Questions = new()
            {
                ...
                [SHexabutton.Letter] = new()
                {
                    ...
                    Question = "Welcher Buchstabe wurde bei {0} als Morsezeichen übermittelt?",
                },
            },
        },
        ...
        [typeof(SHexamaze)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the color of the pawn?"] = "Welche Farbe hatte die Spielfigur?",
            },
            Questions = new()
            {
        ...
        [typeof(SHickoryDickoryDock)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What times were shown when the clock struck?"] = "Welche Uhrzeit wurde bei welchem Geläute angezeigt?",
            },
            Questions = new()
            {
        ...
        [typeof(SHiddenColors)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the main LED’s color?"] = "Welche Farbe hatte die Haupt-LED?",
            },
            Questions = new()
            {
        ...
        [typeof(SHinges)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the initially present hinges?"] = "Welche Scharniere waren anfangs vorhanden?",
            },
            Questions = new()
            {
                [SHinges.Initial] = new()
        ...
        [typeof(SHoldUps)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the name of each shadow shown?"] = "Welchen Namen hatte welcher Schatten?",
            },
            Questions = new()
            {
        ...
        [typeof(SHolographicMemory)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which side did each symbol appear?"] = "Auf welcher Seite erschien welches Symbol?",
            },
            Questions = new()
            {
        ...
        [typeof(SHomophones)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the displayed phrases?"] = "Welcome Phrasen waren auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SHorribleMemory)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the colors and labels of each button in each stage?"] = "Welche Taste hatte in welcher Stufe welche Farbe und welche Aufschrift?",
                ["What digit was displayed in each stage?"] = "Welche Ziffer war in welcher Stufe auf dem Display?",
            },
            Questions = new()
            {
                [SHorribleMemory.QColorsByPosition] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} der Knopf in der {1}en Position in der {2}en Stufe?",
                    Answers = new()
                    {
                        ["blue"] = "blau",
                        ["green"] = "grün",
                ...
                [SHorribleMemory.QColorsByLabel] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} der Knopf mit der Aufschrift {1} in der {2}en Stufe?",
                    Answers = new()
                    {
                        ["blue"] = "blau",
                        ["green"] = "grün",
                ...
                [SHorribleMemory.QLabelsByPosition] = new()
                {
                    ...
                    Question = "Welche Aufschrift hatte bei {0} der Knopf in der {1}en Position in der {2}en Stufe?",
                },
                [SHorribleMemory.QLabelsByColor] = new()
                {
                    ...
                    Question = "Welche Aufschrift hatte bei {0} der {1} Knopf in der {2}en Stufe?",
                    Arguments = new()
                    {
                        ["blue"] = "blaue",
                        ["green"] = "grüne",
                ...
                [SHorribleMemory.QPositionsByColor] = new()
                {
                    ...
                    Question = "An welcher Position war bei {0} der {1} Knopf in der {2}en Stufe?",
                    Arguments = new()
                    {
                        ["blue"] = "blaue",
                        ["green"] = "grüne",
                ...
                [SHorribleMemory.QPositionsByLabel] = new()
                {
                    ...
                    Question = "An welcher Position war bei {0} der Knopf mit der Aufschrift {1} in der {2}en Stufe?",
                    Answers = new()
                    {
                        ["first"] = "eins",
                        ["second"] = "zwei",
            ...
            Discriminators = new()
            {
                [SHorribleMemory.DColorAndPosition] = new()
                {
                    ...
                    Discriminator = "dem Grausigen Memory, bei dem der Knopf in der {1}en Position in der {2}en Stufe {0} war,",
                    Arguments = new()
                    {
                        ["blue"] = "blau",
                        ["green"] = "grün",
                ...
                [SHorribleMemory.DLabelAndPosition] = new()
                {
                    ...
                    Discriminator = "dem Grausigen Memory, bei dem der Knopf in der {1}en Position in der {2}en Stufe die Aufschrift {0} hatte,",
                },
                [SHorribleMemory.DColorAndLabel] = new()
                {
                    ...
                    Discriminator = "dem Grausigen Memory, bei dem der {0} Knopf in der {2}en Stufe die Aufschrift {1} hatte,",
                    Arguments = new()
                    {
                        ["blue"] = "blaue",
                        ["green"] = "grüne",
                ...
                [SHorribleMemory.DDisplay] = new()
                {
                    ...
                    Discriminator = "dem Grausigen Memory, bei dem in der {1}en Stufe eine {0} auf dem Display war,",
                },
            },
        },
        ...
        [typeof(SHumanResources)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which employees and applicants were present?"] = "Welche Angestellten und Bewerber waren vorhanden?",
                ["Which descriptors were shown in red and green?"] = "Welche Beschreibungen kamen in rot bzw. grün vor?",
            },
            Questions = new()
            {
                ...
                [SHumanResources.Employees] = new()
                {
                    ...
                    Question = "Wer war bei {0} am Anfang ein(e) {1}?",
                    Arguments = new()
                    {
                        ["an employee"] = "Angestellter*in",
                        ["an applicant"] = "Bewerber*in",
                    },
                },
            },
        },
        ...
        [typeof(SHunting)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which pictograms were displayed?"] = "Welche Piktogramme kamen vor?",
            },
            Questions = new()
            {
                [SHunting.DisplayedSymbols] = new()
                {
                    ...
                    Question = "Welches Symbol kam bei {0} in der {1}e Stufe vor?",
                },
            },
        },
        ...
        [typeof(SIceCream)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Who were the customers?"] = "Welche Kunden kamen vor?",
                ["Which flavors were on offer to each customer?"] = "Welche Geschmacksrichtungen wurden welchen Kunden angeboten?",
            },
            Questions = new()
            {
        ...
        [typeof(SIdentificationCrisis)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the shapes and identification modules used?"] = "Welche Formen und Identifikationsmodule kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SIdentityParade)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the hair colors, builds and attires listed on the module?"] = "Welche Haarfarben, Körperbaus und Garderoben standen zur Auswahl?",
            },
            Questions = new()
            {
        ...
        [typeof(SInnerConnections)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What color was the LED?"] = "Welche Farbe hatte die LED?",
                ["What was the digit flashed in Morse?"] = "Welche Ziffer wurde in Morsezeichen übermittelt?",
            },
            Questions = new()
            {
        ...
        [typeof(SInterpunct)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the symbol displayed in each stage?"] = "Welches Symbol war in welcher Stufe auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SJewelVault)] = new()
        {
            ...
            Questions = new()
            {
                [SJewelVault.WheelTurns] = new()
                {
                    ...
                    Question = "Welches Rad setzte sich bei {0} durch Bewegung von Rad {1} in Bewegung?",
                    Answers = new()
                    {
                        ["1"] = "1",
                        ["2"] = "2",
        ...
        [typeof(SJuxtacoloredSquares)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was each square’s color?"] = "Welches Feld hatte welche Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SKanji)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the displayed word in each stage?"] = "Welches Wort wurde in welcher Stufe abgefragt?",
            },
            Questions = new()
            {
        ...
        [typeof(SKayMazeyTalk)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the starting and goal words?"] = "Was war das Start- und Zielwort?",
            },
            Questions = new()
            {
        ...
        [typeof(SKeypadMagnified)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the position of the LED?"] = "Wo war die LED?",
            },
            Questions = new()
            {
        ...
        [typeof(SKeypadMaze)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Where were the yellow cells?"] = "Welche Zellen waren gelb?",
            },
            Questions = new()
            {
        ...
        [typeof(SKeypadSequence)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What symbols were on the keys?"] = "Welche Symbole waren auf den Tasten?",
            },
            Questions = new()
            {
        ...
        [typeof(SKeywords)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the letters on the display?"] = "Welche Buchstaben waren auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SKnowYourWay)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which way was the arrow pointing?"] = "In welche Richtung zeigte der Pfeil?",
                ["Which LED was green?"] = "Welche LED war grün?",
            },
            Questions = new()
            {
        ...
        [typeof(SKudosudoku)] = new()
        {
            ManualQuestions = new()
            {
                ["Which squares were initially pre-filled?"] = "Welche Felder waren am Anfang schon ausgefüllt?",
            },
            Questions = new()
            {
        ...
        [typeof(SKugelblitz)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which particles were present during each stage?"] = "Welche Partikel waren in welcher Stufe vorhanden?",
                ["What were the particles’ values during each stage?"] = "Welche Werte hatten die Partikel in welcher Stufe?",
            },
            Questions = new()
            {
        ...
        [typeof(SKuro)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was Kuro’s mood?"] = "Welche Stimmung hatte Kuro?",
            },
            Questions = new()
            {
                [SKuro.Mood] = new()
        ...
        [typeof(SLabyrinth)] = new()
        {
            ...
            Questions = new()
            {
                [SLabyrinth.PortalLocations] = new()
                {
                    ...
                    Question = "Wo war bei {0} auf Ebene {1} eines der Portale?",
                    Arguments = new()
                    {
                        ["1 (Red)"] = "1 (Rot)",
                        ["2 (Orange)"] = "2 (Orange)",
                ...
                [SLabyrinth.PortalStage] = new()
                {
                    ...
                    Question = "Auf welcher Ebene war bei {0} dieses Portal?",
                    Answers = new()
                    {
                        ["1 (Red)"] = "1 (Rot)",
                        ["2 (Orange)"] = "2 (Orange)",
        ...
        {
            ModuleName = "Leiterlotterie",
            Gender = Gender.Feminine,
            ManualQuestions = new()
            {
                ["Which light was on?"] = "Welches Licht war an?",
            },
            Questions = new()
            {
                [SLadderLottery.LightOn] = new()
                {
                    ...
                    Question = "Welches Licht war bei {0} an?",
                },
            },
        },
        ...
        [typeof(SLadders)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which colors were present on the second ladder?"] = "Welche Farben kamen auf der zweiten Leiter vor?",
                ["What color was missing on the third ladder?"] = "Welche Farbe hat auf der dritten Leiter gefehlt?",
            },
            Questions = new()
            {
                [SLadders.Stage2Colors] = new()
                {
                    ...
                    Question = "Welche Farbe kam bei {0} auf der zweiten Leiter vor?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Orange"] = "Orange",
                ...
                [SLadders.Stage3Missing] = new()
                {
                    ...
                    Question = "Welche Farbe hat bei {0} auf der dritten Leiter gefehlt?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Orange"] = "Orange",
        ...
        {
            ModuleName = "Langton-Ameisenbär",
            Gender = Gender.Feminine,
            ManualQuestions = new()
            {
                ["What was the initial state of the grid?"] = "Wie sah das Spielfeld am Anfang aus?",
            },
            Questions = new()
            {
                [SLangtonsAnteater.InitialState] = new()
                {
                    ...
                    Question = "Welches Feld war bei {0} am Anfang {1}?",
                    Arguments = new()
                    {
                        ["black"] = "schwarz",
                        ["white"] = "weiß",
        ...
        {
            ModuleName = "LED-Verschlüsselung",
            Gender = Gender.Feminine,
            ManualQuestions = new()
            {
        ...
        [typeof(SLEDGrid)] = new()
        {
            ModuleName = "LED-Gitter",
            ManualQuestions = new()
            {
                ["How many LEDs were unlit?"] = "Wie viele LEDs waren an?",
            },
            Questions = new()
            {
                [SLEDGrid.NumBlack] = new()
                {
                    ...
                    Question = "Wie viele LEDs waren bei {0} aus?",
                },
            },
        },
        ...
        [typeof(SLEDMath)] = new()
        {
            ...
            Questions = new()
            {
                [SLEDMath.Lights] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} {1}?",
                    Arguments = new()
                    {
                        ["LED A"] = "LED A",
                        ["LED B"] = "LED B",
                        ["the operator LED"] = "die Operator-LED",
                    },
                    Answers = new()
                    {
                        ["Red"] = "Rot",
        ...
        [typeof(SLEDs)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the initial color of the changed LED?"] = "Welche Farbe hatte die LED, die sich verändert hat?",
            },
            Questions = new()
            {
                [SLEDs.OriginalColor] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} die LED, die sich verändert hat?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Orange"] = "Orange",
        ...
        [typeof(SLEGOs)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the dimensions of each color piece?"] = "Welches Teil hatte welche Größe?",
            },
            Questions = new()
            {
                [SLEGOs.PieceDimensions] = new()
                {
                    ...
                    Question = "Welche Größe hatte das {1} Teil in {0}?",
                    Arguments = new()
                    {
                        ["red"] = "rote",
                        ["green"] = "grüne",
        ...
        [typeof(SLetterMath)] = new()
        {
            ...
            Questions = new()
            {
                [SLetterMath.Display] = new()
                {
                    ...
                    Question = "Welcher Buchstabe war bei {0} auf dem {1} Display?",
                    Arguments = new()
                    {
                        ["left"] = "linken",
                        ["right"] = "rechten",
        ...
        [typeof(SLightBulbs)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the colors of the bulbs?"] = "Welche Glühlampe hatte welche Farbe?",
            },
            Questions = new()
            {
                [SLightBulbs.OuterBulb] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} die {1} Glühlampe?",
                    Arguments = new()
                    {
                        ["left"] = "linke",
                        ["right"] = "rechte",
        ...
        {
            ModuleName = "Limette-Pfeile",
            ModuleNameDative = "Limette-Pfeilen",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What was the starting coordinate?"] = "Was waren die Startkoordinaten?",
            },
            Questions = new()
            {
        ...
        [typeof(SLinq)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the functions?"] = "Welche Funktionen kamen vor?",
            },
            Questions = new()
            {
                [SLinq.Function] = new()
        ...
        {
            ModuleName = "Löwenanteil",
            Gender = Gender.Masculine,
            ManualQuestions = new()
            {
                ["Which year was displayed?"] = "Um welches Jahr ging es?",
                ["Which lions were present but removed?"] = "Welche Löwen wurden entfernt?",
            },
            Questions = new()
            {
                [SLionsShare.Year] = new()
                {
                    ...
                    Question = "Um welches Jahr ging es bei {0}?",
                },
        ...
        [typeof(SListening)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What sound played?"] = "Welcher Klang war zu hören?",
            },
            Questions = new()
            {
        ...
        [typeof(SLiteralMaze)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which letter was in each position?"] = "Welcher Buchstabe stand an welcher Stelle?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Logiktasten",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What were the colors and labels of each button in each stage?"] = "Welche Taste hatte in welcher Stufe welche Farbe und welche Aufschrift?",
                ["What were the final operators in each stage?"] = "Was war in welcher Stufe der letzte Operator?",
            },
            Questions = new()
            {
                [SLogicalButtons.Color] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} die {1} Taste in der {2}en Stufe?",
                    Arguments = new()
                    {
                        ["top"] = "obere",
                        ["bottom-left"] = "untere linke",
                ...
                [SLogicalButtons.Label] = new()
                {
                    ...
                    Question = "Welche Aufschrift hatte bei {0} die {1} Taste in der {2}en Stufe?",
                    Arguments = new()
                    {
                        ["top"] = "obere",
                        ["bottom-left"] = "untere linke",
                ...
                [SLogicalButtons.Operator] = new()
                {
                    ...
                    Question = "Was war bei {0} in der {1}en Stufe der letzte Operator?",
                },
            },
        },
        ...
        {
            ModuleName = "Logikgatter",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What were logic gates A-D?"] = "Welches Gatter war A, B, C, D?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Lombax-Würfel",
            ModuleNameDative = "Lombax-Würfeln",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What were the letters on the button?"] = "Welche Buchstaben waren auf den Tasten?",
            },
            Questions = new()
            {
                [SLombaxCubes.Letters] = new()
                {
                    ...
                    Question = "Was war bei {0} der {1}e Buchstabe auf der Taste?",
                },
            },
        },
        ...
        [typeof(SLondonUnderground)] = new()
        {
            ...
            Questions = new()
            {
                [SLondonUnderground.Stations] = new()
                {
                    ...
                    Question = "Welche Haltestelle war bei {0} {2} der {1}en Fahrt?",
                    Arguments = new()
                    {
                        ["depart from"] = "der Ausgangspunkt",
                        ["arrive to"] = "das Ziel",
                    },
                },
            },
        ...
        {
            ModuleName = "Lange Wörter",
            ModuleNameDative = "Langen Wörtern",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What was the word on the top display?"] = "Welches Wort war auf dem oberen Display?",
            },
            Questions = new()
            {
                [SLongWords.Word] = new()
                {
                    ...
                    Question = "Welches Wort war bei {0} auf dem oberen Display?",
                },
            },
        },
        ...
        [typeof(SMadMemory)] = new()
        {
            ManualQuestions = new()
            {
                ["What was on the display in each stage?"] = "Was war in welcher Stufe auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SMafia)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Who was a player, but not the Godfather?"] = "Wer war Mitspieler, aber nicht der Pate?",
            },
            Questions = new()
            {
                [SMafia.Players] = new()
                {
                    ...
                    Question = "Wer war bei {0} ein Mitspieler aber nicht der Pate?",
                },
            },
        },
        ...
        [typeof(SMahjong)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the bottom-left tile?"] = "Welcher Spielstein war unten links zu sehen?",
            },
            Questions = new()
            {
                [SMahjong.CountingTile] = new()
                {
                    ...
                    Question = "Welcher Spielstein war bei {0} unten links zu sehen?",
                },
            },
        },
        ...
        [typeof(SMainPage)] = new()
        {
            ...
            Questions = new()
            {
                [SMainPage.ButtonEffectOrigin] = new()
                {
                    ...
                    Question = "Von welcher Hauptseite kam bei {0} der Effekt der {1}-Taste?",
                    Arguments = new()
                    {
                        ["toons"] = "Toons",
                        ["games"] = "Spiele",
                ...
                [SMainPage.HomestarBackgroundOrigin] = new()
                {
                    ...
                    Question = "Von welcher Hauptseite kam {1} bei {0}?",
                    Arguments = new()
                    {
                        ["Homestar"] = "Homestar",
                ...
                [SMainPage.BubbleColors] = new()
                {
                    ...
                    Question = "Welche Farbe hat die Sprechblase bei {0} nicht angezeigt?",
                    Answers = new()
                    {
                        ["Blue"] = "Blau",
                        ["Green"] = "Grün",
                ...
                [SMainPage.BubbleMessages] = new()
                {
                    ...
                    Question = "Welche dieser Nachrichten kam bei {0} auf der Sprechblase {1}?",
                    Arguments = new()
                    {
                        ["display"] = "vor",
                        ["not display"] = "nicht vor",
                    },
                },
            },
        },
        ...
        [typeof(SMandMs)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the labels on the buttons and their colors?"] = "Welche Taste hatte welche Aufschrift und in welcher Farbe?",
            },
            Questions = new()
            {
                [SMandMs.Colors] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} die Aufschrift der {1}en Taste?",
                    Answers = new()
                    {
                        ["red"] = "rot",
                        ["green"] = "grün",
        ...
        {
            ModuleName = "Schiffsignalflaggen",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What bearing was signaled?"] = "Welche Peilung wurde signalisiert?",
                ["What callsign was signaled?"] = "Welches Rufzeichen wurde signalisiert?",
            },
            Questions = new()
            {
                [SMaritimeFlags.Bearing] = new()
                {
                    ...
                    Question = "Welche Peilung wurde bei {0} signalisiert?",
                },
                [SMaritimeFlags.Callsign] = new()
                {
                    // English: Which callsign was signalled in {0}?
                    Question = "Welches Rufzeichen wurde bei {0} signalisiert?",
                },
            },
        },
        ...
        {
            ModuleName = "Schiffsignalwinker",
            Gender = Gender.Masculine,
            ManualQuestions = new()
            {
                ["Where was the dummy?"] = "Wo war die Finte?",
                ["Which letters were signaled?"] = "Welche Buchstaben wurden signalisiert?",
            },
            Questions = new()
            {
                [SMaritimeSemaphore.Dummy] = new()
                {
                    ...
                    Question = "Wo war bei {0} die Finte?",
                },
        ...
        {
            ModuleName = "Master-Bänder",
            ModuleNameDative = "Master-Bändern",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["Which song was played?"] = "Welcher Song war zu hören?",
            },
            Questions = new()
            {
                [SMasterTapes.PlayedSong] = new()
                {
                    ...
                    Question = "Welcher Song kam bei {0} vor?",
                },
            },
        },
        ...
        {
            ModuleName = "Schiedsrichter",
            Gender = Gender.Masculine,
            ManualQuestions = new()
            {
                ["Which planets were present in each stage?"] = "Welche Planeten kamen in welcher Stufe vor?",
            },
            Questions = new()
            {
                [SMatchRefereeing.Planet] = new()
                {
                    ...
                    Question = "Welcher Planet kam bei {0} in der {1}en Stufe vor?",
                },
            },
        },
        ...
        [typeof(SMathEm)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the color and design of each tile before the shuffle?"] = "Welche Farbe und welches Design hatten die Steine vorm Mischen?",
            },
            Questions = new()
            {
                [SMathEm.Color] = new()
                {
                    ...
                    Question = "Welche Farbe hatte dieser Spielstein bei {0} vor dem Mischen?",
                    Answers = new()
                    {
                        ["White"] = "Weiß",
                        ["Bronze"] = "Bronze",
                ...
                [SMathEm.Label] = new()
                {
                    ...
                    Question = "Welches Design hatte dieser Spielstein bei {0} vor dem Mischen?",
                },
            },
        },
        ...
        [typeof(SMatrix)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which word was part of the latest access code used?"] = "Welches Wort kam im zuletzt verwendeten Zugangscode vor?",
            },
            Questions = new()
            {
                [SMatrix.AccessCode] = new()
                {
                    ...
                    Question = "Welches Wort kam bei {0} im zuletzt verwendeten Zugangscode vor?",
                },
            },
        },
        ...
        [typeof(SMaze)] = new()
        {
            ...
            Questions = new()
            {
                [SMaze.StartingPosition] = new()
                {
                    ...
                    Question = "In welcher {1} war bei {0} die Startposition (von {2} gezählt)?",
                    Arguments = new()
                    {
                        ["column"] = "Spalte",
                        ["row"] = "Reihe",
        ...
        [typeof(SMaze3)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the color of the starting face?"] = "Welche Farbe war auf der Startfläche?",
            },
            Questions = new()
            {
                [SMaze3.StartingFace] = new()
                {
                    ...
                    Question = "Welche Farbe war bei {0} auf der Startfläche?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Blue"] = "Blau",
        ...
        {
            ModuleName = "Labyrinth-Identifikation",
            Gender = Gender.Feminine,
            ManualQuestions = new()
            {
                ["What was the seed?"] = "Was war der Seedcode?",
                ["What function did each button have?"] = "Welche Taste hatte welche Funktion?",
            },
            Questions = new()
            {
                [SMazeIdentification.Seed] = new()
                {
                    ...
                    Question = "Was war bei {0} der Seedcode des Labyrinths?",
                },
                [SMazeIdentification.Num] = new()
                {
                    ...
                    Question = "Welche Funktion hatte bei {0} die {1}-Taste?",
                    Answers = new()
                    {
                        ["Forwards"] = "Vorwärts",
                        ["Clockwise"] = "Im-Uhrzeigersinn",
                ...
                [SMazeIdentification.Func] = new()
                {
                    ...
                    Question = "Mit welcher Taste bei {0} {1}?",
                    Arguments = new()
                    {
                        ["moved you forwards"] = "ging es vorwärts",
                        ["turned you clockwise"] = "drehte man sich im Uhrzeigersinn",
                        ["moved you backwards"] = "ging es rückwärts",
                        ["turned you counter-clockwise"] = "drehte man sich gegen den Uhrzeigersinn",
                    },
                },
            },
        },
        ...
        {
            ModuleName = "Labyrinth-Schüttler",
            Gender = Gender.Masculine,
            ManualQuestions = new()
            {
                ["What was the starting position?"] = "Wo war die Startposition?",
                ["What was the goal position?"] = "Wo war die Zielposition?",
                ["Which positions were the maze markings?"] = "Wo waren die Markierungen?",
            },
            Questions = new()
            {
                [SMazeScrambler.QStart] = new()
                {
                    ...
                    Question = "Wo war bei {0} die Startposition?",
                    Answers = new()
                    {
                        ["top-left"] = "oben links",
                        ["top-middle"] = "oben Mitte",
                ...
                [SMazeScrambler.QIndicators] = new()
                {
                    ...
                    Question = "An welcher dieser Stellen war bei {0} eine Markierung?",
                    Answers = new()
                    {
                        ["top-left"] = "oben links",
                        ["top-middle"] = "oben Mitte",
            ...
            Discriminators = new()
            {
                [SMazeScrambler.DStart] = new()
                {
                    ...
                    Discriminator = "dem Labyrinth-Schüttler, dessen Startposition {0} war,",
                    Arguments = new()
                    {
                        ["top-left"] = "oben links",
                        ["top-middle"] = "oben mittig",
                ...
                [SMazeScrambler.DGoal] = new()
                {
                    ...
                    Discriminator = "dem Labyrinth-Schüttler, dessen Ziel {0} war,",
                    Arguments = new()
                    {
                        ["top-left"] = "oben links",
                        ["top-middle"] = "oben mittig",
                ...
                [SMazeScrambler.DIndicators] = new()
                {
                    ...
                    Discriminator = "dem Labyrinth-Schüttler, der {0} eine Markierung hatte,",
                    Arguments = new()
                    {
                        ["top-left"] = "oben links",
                        ["top-middle"] = "oben mittig",
        ...
        {
            ModuleName = "Labyrinth-Sucher",
            Gender = Gender.Masculine,
            ManualQuestions = new()
            {
                ["How many walls surrounded each cell?"] = "Welche Position war von wie vielen Wänden umgeben?",
                ["What were the starting and goal positions?"] = "Wo war die Start- und Zielposition?",
            },
            Questions = new()
            {
                [SMazeseeker.Cell] = new()
                {
                    ...
                    Question = "Wie viele Wände umgaben bei {0} diese Zelle?",
                },
        ...
        [typeof(SMemory)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the display in each stage?"] = "Welche Ziffer war in welcher Stufe auf dem Display?",
            },
            Questions = new()
            {
                [SMemory.QDisplay] = new()
                {
                    ...
                    Question = "Welche Zahl war bei {0} in der {1}en Stufe auf dem Display?",
                },
            },
            Discriminators = new()
            {
                [SMemory.DDisplay] = new()
                {
                    ...
                    Discriminator = "dem Memory, in dessen {1}er Stufe {0} auf dem Display war,",
                },
            },
        },
        ...
        {
            ModuleName = "Memory-Drähte",
            ModuleNameDative = "Memory-Drähten",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What were the wire colours?"] = "Welche Farbe hatten die Drähte?",
                ["What were the displayed digits?"] = "Welche Ziffern waren auf dem Display?",
            },
            Questions = new()
            {
                [SMemoryWires.QWireColours] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} Draht {1}?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Yellow"] = "Gelb",
            ...
            Discriminators = new()
            {
                [SMemoryWires.DWireColours] = new()
                {
                    ...
                    Discriminator = "den Memory-Drähten, bei denen Draht {0} {1} war,",
                    Arguments = new()
                    {
                        ["red"] = "rot",
                        ["yellow"] = "gelb",
                ...
                [SMemoryWires.DDisplayedDigits] = new()
                {
                    ...
                    Discriminator = "den Memory-Drähten, bei denen in der {0}en Stufe eine {1} auf dem Display war,",
                },
            },
        },
        ...
        [typeof(SMetamorse)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the extracted letter?"] = "Welcher Buchstabe wurde entnommen?",
            },
            Questions = new()
            {
                [SMetamorse.ExtractedLetter] = new()
                {
                    ...
                    Question = "Welcher Buchstabe wurde bei {0} entnommen?",
                },
            },
        },
        ...
        [typeof(SMetapuzzle)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the final answer?"] = "Was war das Lösungswort am Ende?",
            },
            Questions = new()
            {
        ...
        [typeof(SMinskMetro)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the starting station?"] = "An welcher Haltestelle ging es los?",
            },
            Questions = new()
            {
        ...
        [typeof(SMirror)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the second word written by the original ghost?"] = "Was war das zweite vom ursprünglichen Geist geschriebene Wort?",
            },
            Questions = new()
            {
                [SMirror.Word] = new()
        ...
        [typeof(SMisterSoftee)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Where was the SpongeBob Bar?"] = "Wo war das Spongebob-Eis?",
                ["Which treats were present?"] = "Welche Eissorten waren im Angebot?",
            },
            Questions = new()
            {
        ...
        [typeof(SMixometer)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the position of the submit button?"] = "Wo war die Eingabetaste?",
            },
            Questions = new()
            {
                [SMixometer.SubmitButton] = new()
                {
                    ...
                    Question = "Wo war bei {0} die Eingabetaste?",
                },
            },
        },
        ...
        {
            ModuleName = "Modulen Zuhören",
            ManualQuestions = new()
            {
                ["What sounds played?"] = "Welche Sounds waren zu hören?",
                ["What sounds did each button play?"] = "Welche Sounds wurden durch welche Taste ausgelöst?",
            },
            Questions = new()
            {
                [SModuleListening.ButtonAudio] = new()
                {
                    ...
                    Question = "Welcher Sound wurde bei {0} durch die {1} Taste ausgelöst?",
                    Arguments = new()
                    {
                        ["red"] = "rote",
                        ["green"] = "grüne",
                ...
                [SModuleListening.AnyAudio] = new()
                {
                    ...
                    Question = "Welcher Sound kam bei {0} vor?",
                },
            },
        },
        ...
        [typeof(SModuleManeuvers)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the goal location?"] = "Wo war das Ziel?",
            },
            Questions = new()
            {
                [SModuleManeuvers.Goal] = new()
                {
                    ...
                    Question = "Wo war bei {0} die Zielposition?",
                    // Refer to translations.md to understand the weird strings
                    Additional = new()
                    {
                        ["{0}, {1}"] = "{0}, {1}",
        ...
        {
            ModuleName = "Modullabyrinth",
            ManualQuestions = new()
            {
                ["What was the starting icon?"] = "Was war das Startsymbol?",
            },
            Questions = new()
            {
                [SModuleMaze.StartingIcon] = new()
                {
                    ...
                    Question = "Welches dieser Symbole war bei {0} der Startpunkt?",
                },
            },
        },
        ...
        {
            ModuleName = "Modulbewegungen",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What module was shown for each stage?"] = "Welches Modul kam in welcher Stufe vor?",
            },
            Questions = new()
            {
                [SModuleMovements.Display] = new()
                {
                    ...
                    Question = "Welches Modul war bei {0} als {1}es auf dem Display?",
                },
            },
        },
        ...
        [typeof(SMoneyGame)] = new()
        {
            ...
            Questions = new()
            {
                [SMoneyGame.Question1] = new()
                {
                    ...
                    Question = "Was waren bei {0} das erste und zweite Wort in der {1}en Phrase?",
                },
                [SMoneyGame.Question2] = new()
                {
                    ...
                    Question = "Was waren bei {0} das dritte und vierte Wort in der {1}en Phrase?",
                },
                [SMoneyGame.Question3] = new()
                {
                    ...
                    Question = "Was war bei {0} das Ende der {1}en Phrase?",
                },
            },
        },
        ...
        {
            ModuleName = "Monsplode, Kämpfe!",
            ManualQuestions = new()
            {
                ["Which creature was displayed?"] = "Welche Kreatur war auf dem Display?",
                ["Which moves were selectable?"] = "Welche Züge waren auswählbar?",
            },
            Questions = new()
            {
                [SMonsplodeFight.Creature] = new()
                {
                    ...
                    Question = "Welche Kreatur war bei {0} auf dem Display?",
                },
                [SMonsplodeFight.Move] = new()
                {
                    ...
                    Question = "Welcher dieser Züge stand bei {0} {1}?",
                    Arguments = new()
                    {
                        ["was"] = "zur Auswahl",
                        ["was not"] = "nicht zur Auswahl",
                    },
                },
            },
        },
        ...
        {
            ModuleName = "Monsplode-Tauschkarten",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What were the names and print versions of the three cards in your hand before the final trade/keep?"] = "Welche Namen und Druckversionen hatten die drei Karten auf der Hand vor der letzten Aktion?",
            },
            Questions = new()
            {
                [SMonsplodeTradingCards.CardsAny] = new()
                {
                    ...
                    Question = "Welche Karte war bei {0} vor der letzten Aktion auf der Hand?",
                },
                [SMonsplodeTradingCards.PrintVersionsAny] = new()
                {
                    ...
                    Question = "Welche Printversion kam bei {0} vor der letzten Aktion unter den Karten auf der Hand vor?",
                },
            },
        },
        ...
        {
            ModuleName = "Mehr-Code",
            ManualQuestions = new()
            {
                ["What was the flashing word?"] = "Welches Wort wurde übermittelt?",
            },
            Questions = new()
            {
                [SMoreCode.Word] = new()
        ...
        {
            ModuleName = "Morse-Labyrinth",
            ManualQuestions = new()
            {
                ["What were the starting and ending locations?"] = "Wo waren die Start- und Zielposition?",
                ["What was the Morse code word played?"] = "Welches Wort wurde in Morsezeichen übermittelt?",
            },
            Questions = new()
            {
                ...
                [SMorseAMaze.MorseCodeWord] = new()
                {
                    ...
                    Question = "Welches Wort wurde bei {0} in Morsezeichen übermittelt?",
                },
            },
        },
        ...
        {
            ModuleName = "Morse-Tasten",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What were the characters and colors flashed by each button?"] = "Welche Zeichen wurden von welchen Tasten in welchen Farben übermittelt?",
            },
            Questions = new()
            {
                [SMorseButtons.ButtonLabel] = new()
                {
                    ...
                    Question = "Welches Zeichen wurde bei {0} von der {1}en Taste übermittelt?",
                },
                [SMorseButtons.ButtonColor] = new()
                {
                    ...
                    Question = "In welcher Farbe leuchtete bei {0} die {1}e Taste auf?",
                    Answers = new()
                    {
                        ["red"] = "Rot",
                        ["blue"] = "Blau",
        ...
        [typeof(SMorsematics)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the received letters?"] = "Welche Buchstaben wurden übermittelt?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Kriegsmorse",
            ManualQuestions = new()
            {
                ["What were the LEDs?"] = "Welche LEDs waren an/aus?",
                ["What code was transmitted?"] = "Welcher Code wurde übermittelt?",
            },
            Questions = new()
            {
                [SMorseWar.Code] = new()
                {
                    ...
                    Question = "Welcher Code wurde bei {0} übermittelt?",
                },
                [SMorseWar.Leds] = new()
                {
        ...
        [typeof(SMorseWoF)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the display words?"] = "Welche Wörter standen auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SMouseInTheMaze)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What color was the torus?"] = "Welche Farbe hatte der Torus?",
            },
            Questions = new()
            {
        ...
        [typeof(SMSeq)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the obtained digits?"] = "Wie lauteten die ermittelten Ziffern?",
                ["What was the final number from the iteration process?"] = "Was war die letzte Ziffer aus dem Iterationsprozess?",
            },
            Questions = new()
            {
                [SMSeq.Obtained] = new()
        ...
        [typeof(SMssngvWls)] = new()
        {
            ...
            ModuleNameDative = "Fehlenden Vokale",
            Gender = Gender.Plural,
            ManualModuleName = "Fhlndv Kl",
            ManualQuestions = new()
            {
                ["What was the missing vowel?"] = "Welcher Vokal hat gefehlt?",
            },
            Questions = new()
            {
        ...
        [typeof(SMulticoloredSwitches)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the colors of the LEDs in both cycles?"] = "Welche Farbe hatte welche LED in welchem der zwei Zyklen?",
            },
            Questions = new()
            {
        ...
        [typeof(SMurder)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which were the suspects and weapons?"] = "Welche Verdächtigten und Waffen kamen vor?",
                ["Where was the body found?"] = "Wo wurde die Leiche gefunden?",
            },
            Questions = new()
            {
                [SMurder.Suspect] = new()
        ...
        {
            ModuleName = "Mystisches Quadrat",
            ModuleNameDative = "Mystischen Quadrat",
            ManualQuestions = new()
            {
                ["What digit was initially in the center?"] = "Welche Ziffer war am Anfang in der Mitte?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Namenskonventionen",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What was the label of the first button?"] = "Was stand auf der ersten Taste?",
            },
            Questions = new()
            {
        ...
        [typeof(SNandNs)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the labels in stage 2 and 3?"] = "Welche Beschriftungen kamen in Stufe 2 und 3 vor?",
                ["What was the missing color in stage 3?"] = "Welche Farbe hat in Stufe 3 gefehlt?",
            },
            Questions = new()
            {
                [SNandNs.Label] = new()
                {
                    ...
                    Question = "Welche Aufschrift kam bei {0} in der {1}en Stufe vor?",
                },
                [SNandNs.Color] = new()
                {
                    // English: Which color was missing in the third stage of {0}?
                    Question = "Welche Farbe hat bei {0} in der dritten Stufe gefehlt?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Green"] = "Grün",
        ...
        [typeof(SNavigationDetermination)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the color and label of the maze?"] = "Welche Farbe und Beschriftung hatte das Labyrinth?",
            },
            Questions = new()
            {
        ...
        [typeof(SNavinums)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which directional buttons were pressed?"] = "Welche Richtungstasten wurden gedrückt?",
                ["What was the initial middle digit?"] = "Welche Ziffer war am Anfang in der Mitte?",
            },
            Questions = new()
            {
        ...
        [typeof(SNavyButton)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ...
                ["What were the coordinates and value of the given?"] = "Welche Koordinaten und welchen Wert hatte die vorgegebene Stelle?",
            },
            Questions = new()
            {
            ...
            Discriminators = new()
            {
                ...
                [SNavyButton.DGiven] = new()
                {
                    ...
                    Discriminator = "dem Königsblauen Knopf, bei dem {0} {1} war, ",
                    Arguments = new()
                    {
                        ["(0-indexed) column"] = "der vorgegebene Wert in (0-basierter) Spalte",
                        ["(0-indexed) row"] = "der vorgegebene Wert in (0-basierter) Reihe",
                        ["value"] = "der vorgegebene Wert",
                    },
                },
            },
        ...
        [typeof(SNeptune)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which star was displayed?"] = "Welcher Stern kam vor?",
            },
            Questions = new()
            {
                [SNeptune.Star] = new()
        ...
        {
            ModuleName = "Neutralisierung",
            Gender = Gender.Feminine,
            ManualQuestions = new()
            {
                ["What was the acid’s color/volume?"] = "Welche Farbe und welches Volumen hatte die Säure?",
            },
            Questions = new()
            {
                [SNeutralization.QColor] = new()
                {
                    ...
                    Question = "Welche Farbe hatte die Säure bei {0}?",
                    Answers = new()
                    {
                        ["Yellow"] = "Gelb",
                        ["Green"] = "Grün",
                ...
                [SNeutralization.QVolume] = new()
                {
                    ...
                    Question = "Welches Volumen hatte die Säure bei {0}?",
                },
            },
            Discriminators = new()
            {
                [SNeutralization.DColor] = new()
                {
                    ...
                    Discriminator = "der Neutralisierung, bei der die Farbe {0} war",
                    Arguments = new()
                    {
                        ["yellow"] = "gelb",
                        ["green"] = "grün",
                ...
                [SNeutralization.DVolume] = new()
                {
                    ...
                    Discriminator = "der Neutralisierung, bei der das Volumen {0} war",
                },
            },
        },
        ...
        [typeof(SNextInLine)] = new()
        {
            ManualQuestions = new()
            {
                ["What color was the first wire?"] = "Welche Farbe hatte der erste Draht?",
            },
            Questions = new()
            {
                [SNextInLine.FirstWire] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} der erste Draht?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Orange"] = "Orange",
        ...
        [typeof(SNim)] = new()
        {
            ManualQuestions = new()
            {
                ["How many matches were in each row?"] = "Welche Reihe hatte wie viele Streichhölzer?",
            },
            Questions = new()
            {
        ...
        [typeof(SNonverbalSimon)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the flashes?"] = "Was hat geblinkt?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotColoredSquares)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What position did you initially press?"] = "Welche Position wurde als erste eingegeben?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotColoredSwitches)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the encrypted word?"] = "Wie lautete das verschlüsselte Wort?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotColourFlash)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the displayed word and colour sequences?"] = "Welche Wort- und Farbfolgen kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotDoubleOh)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the displayed positions in the second stage?"] = "Welche Positionen waren in der zweiten Stufe auf dem Display?",
            },
            Questions = new()
            {
            ...
            Discriminators = new()
            {
                [SNotDoubleOh.DPosition] = new()
                {
                    ...
                    Discriminator = "der Doppel-Null Mal Anders, bei der die {0}e angezeigte Position {1} war,",
                },
            },
        },
        ...
        [typeof(SNotKeypad)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which colours flashed in the final sequence?"] = "Aus welchen Farben bestand die endgültige Folge?",
                ["Which symbols were on the buttons that flashed in the final sequence?"] = "Welche Symbole waren auf den in der endgültigen Folge vertretenen Tasten?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotMaze)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the starting distance?"] = "Was war die Startdistanz?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotMorseCode)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the transmitted words?"] = "Welche Wörter wurden übermittelt?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotNumberPad)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which numbers flashed at each stage?"] = "Welche Zahlen haben in welchen Stufen geleuchtet?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotPerspectivePegs)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the positions, perspectives, and colors of each flash?"] = "Welche Farbe leuchtete an welcher Position und in welcher Perspektive?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotPianoKeys)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the displayed symbols?"] = "Welche Symbole waren zu sehen?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotSimaze)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which maze was used?"] = "Welches Labyrinth kam zum Einsatz?",
                ["What were the starting and goal positions?"] = "Wo war die Start- und Zielposition?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotTextField)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which letter appeared 9 times at the start?"] = "Welcher Buchstabe kam am Anfang 9-mal vor?",
                ["Which letters were pressed in the first stage?"] = "Welche Buchstaben wurden in der ersten Stufe eingegeben?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotTheBulb)] = new()
        {
            ...
            Gender = Gender.Feminine,
            ManualModuleName = "Die\uE001Glühlampe Mal Anders",
            ManualQuestions = new()
            {
        ...
        [typeof(SNotTheButton)] = new()
        {
            ...
            Gender = Gender.Masculine,
            ManualModuleName = "Der\uE001Knopf Mal Anders",
            ManualQuestions = new()
            {
                ["What color did the light glow?"] = "In welcher Farbe leuchtete der Streifen?",
            },
        ...
        [typeof(SNotThePlungerButton)] = new()
        {
            ...
            Gender = Gender.Masculine,
            ManualModuleName = "Der\uE001Kolbenknopf Mal Anders",
            ManualQuestions = new()
            {
                ["What colors did the background flash?"] = "In welchen Farben leuchtete der Hintergrund?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotTheScrew)] = new()
        {
            ...
            Gender = Gender.Feminine,
            ManualModuleName = "Die\uE001Schraube Mal Anders",
            ManualQuestions = new()
            {
                ["What was the initial position?"] = "Wo war die Startposition?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotWordSearch)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which consonants were missing?"] = "Welche Konsonanten haben gefehlt?",
                ["What was the first correctly pressed letter?"] = "Welcher Buchstabe wurde als erstes korrekt eingegeben?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotX01)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the sector values?"] = "Welche Sektorwerte kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SNotXRay)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What table were we in?"] = "Welches Labyrinth kam zum Einsatz?",
                ["Which button went which direction?"] = "Welche Taste ging in welche Richtung?",
                ["What was the scanner color?"] = "Welche Farbe hatte der Scanner?",
            },
            Questions = new()
            {
        ...
        [typeof(SNumbers)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What two-digit number was given?"] = "Welche 2-stellige Zahl war vorgegeben?",
            },
            Questions = new()
            {
        ...
        [typeof(SNumpath)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the number and its color?"] = "Welche Zahl kam in welcher Farbe vor?",
            },
            Questions = new()
            {
                [SNumpath.Color] = new()
        ...
        [typeof(SOctadecayotton)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ...
                ["What were the subtransformations in each transformation?"] = "Welche Transformation bestand aus welchen Teiltransformationen?",
            },
            Questions = new()
            {
        ...
        [typeof(SOffKeys)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the displayed runes?"] = "Welche Runen waren auf dem Display?",
                ["Which keys played at an incorrect pitch?"] = "Welche Tasten waren in der Tonlage falsch?",
            },
            Questions = new()
            {
        ...
        [typeof(SOffWhiteCipher)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was on each display?"] = "Was war auf welchem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SOldAI)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the group/sub-group of the displayed numbers?"] = "Zu welcher Gruppe/Untergruppe gehörten die angezeigten Zahlen?",
            },
            Questions = new()
            {
                [SOldAI.Group] = new()
        ...
        [typeof(SOldFogey)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the initial color of the status light?"] = "Welche Farbe hatte am Anfang das Modullämpchen?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Ein Link Für Alle",
            Gender = Gender.Masculine,
            ManualQuestions = new()
            {
                ["What were the initially displayed articles?"] = "Welche Artikel waren am Anfang zu sehen?",
            },
            Questions = new()
            {
                [SOneLinksToAll.Start] = new()
                {
                    ...
                    Question = "Bei welchem Artikel ging es bei {0} los?",
                },
                [SOneLinksToAll.End] = new()
                {
                    // English: What was the ending article in {0}?
                    Question = "Bei welchem Artikel hörte es bei {0} auf?",
                },
            },
        },
        ...
        [typeof(SOnlyConnect)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the positions of the Egyptian hieroglyphs?"] = "Welche ägyptische Hieroglyphe war an welcher Stelle?",
            },
            Questions = new()
            {
        ...
        [typeof(SOrangeArrows)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the first three arrows on the display in each stage?"] = "Welche Pfeile waren in welcher Stufe unter den ersten drei?",
            },
            Questions = new()
            {
        ...
        [typeof(SOrderPicking)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the order ID, product ID and pallet for each order?"] = "Welche Bestellung hatte welche Bestellnummer, Produktnummer und Palette?",
            },
            Questions = new()
            {
        ...
        [typeof(SOrientationCube)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the observer’s initial position?"] = "Wo war der Beobachter am Anfang?",
            },
            Questions = new()
            {
        ...
        [typeof(SOrientationHypercube)] = new()
        {
            ...
            {
                ["What was the observer’s initial position?"] = "Wo war der Beobachter am Anfang?",
                ["What was the initial colour of each face?"] = "Welche Fläche hatte am Anfang welche Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SPaintingCube)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What color was missing?"] = "Welche Farbe hat gefehlt?",
            },
            Questions = new()
            {
        ...
        [typeof(SPapasPizzeria)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the order code?"] = "Was war die Bestellnummer?",
            },
            Questions = new()
            {
        ...
        [typeof(SParity)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was shown on the display?"] = "Was stand auf dem Display?",
            },
            Questions = new()
            {
                [SParity.Display] = new()
        ...
        [typeof(SPartialDerivatives)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the terms of the function?"] = "Was waren die Terme der Funktion?",
                ["What were the LED colors in each stage?"] = "Welche LED hatte in welcher Stufe welche Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SPasswordDestroyer)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the 2FAST™ value?"] = "Was war der 2FAST™-Wert?",
            },
            Questions = new()
            {
        ...
        [typeof(SPatternCube)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which symbol was highlighted?"] = "Welches Symbol war hervorgehoben?",
            },
            Questions = new()
            {
        ...
        [typeof(SPatternRecognition)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the repeating pattern?"] = "Was war das sich wiederholende Muster?",
            },
            Questions = new()
            {
        ...
        [typeof(SPerspectivePegs)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the initial color sequence?"] = "Was war die anfängliche Farbfolge?",
            },
            Questions = new()
            {
        ...
        [typeof(SPickupIdentification)] = new()
        {
            ManualQuestions = new()
            {
                ["What pickups were shown?"] = "Welche Pickups waren zu sehen?",
            },
            Questions = new()
            {
        ...
        [typeof(SPie)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the digits shown?"] = "Welche Ziffern waren zu sehen?",
            },
            Questions = new()
            {
                [SPie.Digits] = new()
        ...
        [typeof(SPieFlash)] = new()
        {
            ManualQuestions = new()
            {
                ["What numbers were displayed?"] = "Welche Zahlen waren auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SPinpoint)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the given point coordinates and distances?"] = "Wie lauteten die Punktkoordinaten und Abstände?",
            },
            Questions = new()
            {
        ...
        [typeof(SPlacementRoulette)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the character, track, and vehicle listed?"] = "Welche Figur, Rennstrecke und Rennwagen waren aufgelistet?",
            },
            Questions = new()
            {
        ...
        [typeof(SPlanets)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the planet shown?"] = "Welcher Planet war zu sehen?",
                ["What was the color for each strip?"] = "Welcher Streifen hatte welche Farbe?",
            },
            Questions = new()
            {
                [SPlanets.Strips] = new()
        ...
        [typeof(SPrisonBreak)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Where did the prisoner and defuser start?"] = "Wo ging es für den Gefangenen und den Entschärfer los?",
            },
            Questions = new()
            {
        ...
        [typeof(SProbing)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the missing frequencies in each wire?"] = "Welche Frequenzen haben in welchem Draht gefehlt?",
            },
            Questions = new()
            {
        ...
        [typeof(SProceduralMaze)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the initial seed?"] = "Was war der Seedcode?",
            },
            Questions = new()
            {
        ...
        [typeof(SPunctuationMarks)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the displayed number?"] = "Welche Zahl wurde angezeigt?",
            },
            Questions = new()
            {
        ...
        [typeof(SPurpleArrows)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the target word?"] = "Was war das Zielwort?",
            },
            Questions = new()
            {
        ...
        [typeof(SPuzzleIdentification)] = new()
        {
            ManualQuestions = new()
            {
                ["What game did each puzzle come from?"] = "Welches Rätsel war aus welchem Spiel?",
                ["What was the name and number of each puzzle?"] = "Welches Rätsel hatte welchen Namen und welche Nummer?",
            },
            Questions = new()
            {
        ...
        [typeof(SPuzzlingHexabuttons)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What letters were shown during submission?"] = "Welche Buchstaben waren während der Eingabe zu sehen?",
            },
            Questions = new()
            {
        ...
        [typeof(SQnA)] = new()
        {
            ManualQuestions = new()
            {
                ["What questions were asked?"] = "Welche Fragen wurden gestellt?",
            },
            Questions = new()
            {
                [SQnA.Questions] = new()
        ...
        [typeof(SQuadrants)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was on each button in each stage?"] = "Was stand in welcher Stufe auf welcher Taste?",
            },
            Questions = new()
            {
        ...
        [typeof(SQuantumPasswords)] = new()
        {
            ...
            ModuleNameDative = "Quantenpasswörtern",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["Which words were used?"] = "Welche Wörter kamen vor?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Schnellarithmetik",
            Gender = Gender.Feminine,
            ManualQuestions = new()
            {
                ["What were the digits and colors in both sequences?"] = "Welche der zwei Folgen enthielt welche Ziffern und Farben?",
            },
            Questions = new()
            {
                [SQuickArithmetic.Colors] = new()
                {
                    ...
                    Question = "Was war bei {0} die {1}e Farbe in der Primärfolge?",
                    Answers = new()
                    {
                        ["red"] = "rot",
                        ["blue"] = "blau",
                ...
                [SQuickArithmetic.PrimSecDigits] = new()
                {
                    ...
                    Question = "Was war bei {0} die {1}e Ziffer in der {2}?",
                    Arguments = new()
                    {
                        ["primary"] = "Primärfolge",
                        ["secondary"] = "Sekundärfolge",
                    },
                },
            },
        },
        ...
        {
            ModuleName = "Quintupel",
            ModuleNameDative = "Quintupeln",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What were the numbers and colors in every slot?"] = "Welche Stelle enthielt welche Zahlen und Farben?",
                ["How many numbers were there of each color?"] = "Wie viele Zahlen gab es von welcher Farbe?",
            },
            Questions = new()
            {
                [SQuintuples.Numbers] = new()
                {
                    ...
                    Question = "Was war bei {0} die {1}e Ziffer an der {2}en Stelle?",
                },
                [SQuintuples.Colors] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} die {1}e Ziffer an der {2}en Stelle?",
                    Answers = new()
                    {
                        ["red"] = "rot",
                        ["blue"] = "blau",
                ...
                [SQuintuples.ColorCounts] = new()
                {
                    ...
                    Question = "Wie viele Zahlen waren bei {0} {1}?",
                    Arguments = new()
                    {
                        ["red"] = "rot",
                        ["blue"] = "blau",
        ...
        [typeof(SQuiplash)] = new()
        {
            ManualQuestions = new()
            {
                ["What number was shown?"] = "Welche Zahl stand auf dem Modul?",
            },
            Questions = new()
            {
                [SQuiplash.Number] = new()
                {
                    ...
                    Question = "Welche Zahl stand bei {0} auf dem Modul?",
                },
            },
        },
        ...
        [typeof(SQuizBuzz)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the number initially on the display?"] = "Welche Zahl war am Anfang auf dem Display?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Tempelraubzug",
            Gender = Gender.Masculine,
            ManualQuestions = new()
            {
                ["How many jewels were initially in the common pool?"] = "Wie viele Juwelen waren am Anfang im gemeinsamen Pool?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Regenbogenpfeile",
            ModuleNameDative = "Regenbogenpfeilen",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What was the displayed number?"] = "Welche Zahl war auf dem Display?",
        ...
        {
            ModuleName = "Rekursives Passwort",
            ModuleNameDative = "Rekursiven Passwort",
            ManualQuestions = new()
            {
                ["What were the incomplete words?"] = "Wie lauteten die unvollständigen Wörter?",
                ["What was the password?"] = "Wie lautete das Passwort?",
            },
            Questions = new()
            {
                [SRecursivePassword.NonPasswordWords] = new()
                {
                    ...
                    Question = "Welches dieser Wörter kam bei {0} vor, war aber nicht das Passwort?",
                },
                [SRecursivePassword.Password] = new()
                {
                    // English: What was the password in {0}?
                    Question = "Was war bei {0} das Passwort?",
                },
            },
        },
        ...
        {
            ModuleName = "Rote Pfeile",
            ModuleNameDative = "Roten Pfeilen",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What was the starting number?"] = "Wie lautete die Startzahl?",
        ...
        {
            ModuleName = "Roter Knopf Mal Anders",
            ModuleNameDative = "Roten Knopf Mal Anders",
            Gender = Gender.Masculine,
            ManualQuestions = new()
            {
                ["What was the displayed word?"] = "Welches Wort war auf dem Display?",
            ...
            Questions = new()
            {
                [SRedButtont.Word] = new()
                {
                    ...
                    Question = "Welches Wort kam bei {0} vor „SUBMIT“?",
                },
            },
        },
        ...
        [typeof(SRedHerring)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the first color flashed?"] = "Welche Farbe ist als erste aufgeleuchtet?",
            },
            Questions = new()
            {
        ...
        [typeof(SReGretBFiltering)] = new()
        {
            ManualQuestions = new()
            {
                ["Which calculations were used?"] = "Welche Berechnungen kamen vor?",
            },
            Questions = new()
            {
                [SReGretBFiltering.Operator] = new()
                {
                    ...
                    Question = "Welcher Operator kam bei {0} in der {1}en Stufe vor?",
                },
            },
        },
        ...
        {
            ModuleName = "Normales Verrücktes Gerede",
            ModuleNameDative = "Normalen Verrückten Gerede",
            ManualQuestions = new()
            {
                ["What was the displayed digit that corresponded to the solution phrase?"] = "Welche Ziffer auf dem Display gehörte zur Lösungsphrase?",
                ["What was the embellishment of the solution phrase?"] = "Welche Verzierung hatte die Lösungsphrase?",
            },
            Questions = new()
            {
                [SRegularCrazyTalk.Digit] = new()
                {
                    ...
                    Question = "Welche Ziffer entsprach bei {0} der Lösungsphrase?",
                },
                [SRegularCrazyTalk.Modifier] = new()
                {
                    // English: What was the embellishment of the solution phrase in {0}?
                    Question = "Welche Verzierung hatte bei {0} die Lösungsphrase?",
                    Answers = new()
                    {
                        ["[PHRASE]"] = "[PHRASE]",
        ...
        {
            ModuleName = "Umgeordnete Tasten",
            ModuleNameDative = "Umgeordneten Tasten",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What were the labels, their colors, and the colors of the keys initially in each stage?"] = "In welcher Stufe hatte welche Taste am Anfang welche Farbe, Aufschrift und Aufschriftfarbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SRetirement)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which houses were on offer, but not chosen by Bob?"] = "Welche Altersheime waren im Angebot, aber nicht Bobs Wahl?",
            },
            Questions = new()
            {
                [SRetirement.Houses] = new()
                {
                    ...
                    Question = "Welches Altersheim war bei {0} im Angebot, aber nicht Bobs Wahl?",
                },
            },
        },
        ...
        [typeof(SReverseMorse)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the displayed symbols and their colors?"] = "Welche Symbole waren auf dem Display und in welcher Farbe?",
            },
            Questions = new()
            {
                [SReverseMorse.Symbols] = new()
                {
                    ...
                    Question = "Was war bei {0} das {1}e Symbol in der {2}en Nachricht?",
                },
        ...
        {
            ModuleName = "Umgekehrte Polnische Notation",
            ModuleNameDative = "Umgekehrten Polnischen Notation",
            Gender = Gender.Feminine,
            ManualQuestions = new()
            {
                ["What characters were used in each round?"] = "Welche Zeichen kamen in welcher Stufe vor?",
            },
            Questions = new()
            {
                [SReversePolishNotation.Character] = new()
                {
                    ...
                    Question = "Welches Zeichen kam bei {0} in der {1}en Runde vor?",
                },
            },
        },
        ...
        [typeof(SRGBEncryption)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the Morse code and color sequences?"] = "Wie lautete die Morse- und die Farbsequenz?",
            },
            Questions = new()
            {
        ...
        [typeof(SRGBMaze)] = new()
        {
            ModuleName = "RGB-Labyrinth",
            ManualQuestions = new()
            {
                ["Where were the exit and keys of the maze?"] = "Wo im Labyrinth waren die Schlüssel und das Ziel?",
                ["What was the maze number for each maze?"] = "Welches Labyrinth hatte welche Nummer?",
            },
            Questions = new()
            {
                [SRGBMaze.Keys] = new()
                {
                    ...
                    Question = "Wo war bei {0} der {1} Schlüssel?",
                    Arguments = new()
                    {
                        ["red"] = "rote",
                        ["green"] = "grüne",
                ...
                [SRGBMaze.Number] = new()
                {
                    ...
                    Question = "Welche Nummer hatte bei {0} das {1} Labyrinth?",
                    Arguments = new()
                    {
                        ["red"] = "rote",
                        ["green"] = "grüne",
                ...
                {
                    // English: What was the exit coordinate in {0}?
                    Question = "Wo war bei {0} die Zielkoordinate?",
                },
            },
        },
        ...
        [typeof(SRhythms)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the color?"] = "Welche Farbe hatte die LED?",
            },
            Questions = new()
            {
                [SRhythms.Color] = new()
        ...
        [typeof(SRNGCrystal)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Where were the taps?"] = "Wo waren die Taps?",
            },
            Questions = new()
            {
                [SRNGCrystal.Taps] = new()
                {
                    ...
                    Question = "Welches Bit hatte bei {0} einen Tap? (Das Ergebnis nach Verschiebung ist in Bit 0.)",
                },
            },
        },
        ...
        {
            ModuleName = "RoboScanner",
            Gender = Gender.Masculine,
            ManualQuestions = new()
            {
                ["Where was the empty cell?"] = "Wo war die leere Zelle?",
            },
            Questions = new()
            {
                [SRoboScanner.EmptyCell] = new()
                {
                    ...
                    Question = "Wo war bei {0} die leere Zelle?",
                },
            },
        },
        ...
        [typeof(SRobotProgramming)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the shapes and colors of the robots?"] = "Welcher Roboter hatte welche Form und welche Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SRoger)] = new()
        {
            ManualQuestions = new()
            {
                ["What four-digit number was given?"] = "Wie lautete die vorgegebene 4-stellige Zahl?",
            },
            Questions = new()
            {
                [SRoger.Seed] = new()
        ...
        [typeof(SRPSJudging)] = new()
        {
            ...
            Questions = new()
            {
                [SRPSJudging.QGesture] = new()
                {
                    ...
                    Question = "Welche Geste zeigte {2} bei {0} in der {1}en Runde?",
                    Arguments = new()
                    {
                        ["blue"] = "Team Blau",
                        ["red"] = "Team Rot",
            ...
            Discriminators = new()
            {
                [SRPSJudging.DGesture] = new()
                {
                    ...
                    Discriminator = "dem SSP-Richter, bei dem {0} diese Geste in der {1}en Runde zeigte,",
                    Arguments = new()
                    {
                        ["blue"] = "Team Blau",
                        ["red"] = "Team Rot",
        ...
        [typeof(SRuleOfThree)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the positions of each sphere on each axis in each cycle?"] = "In welchem Zyklus hatte welche Kugel welche Position auf welcher Achse?",
                ["What were the coordinates of the vertices?"] = "Welche Koordinaten hatten die Eckpunkte?",
            },
            Questions = new()
            {
        ...
        [typeof(SSafetySquare)] = new()
        {
            ...
            Questions = new()
            {
                [SSafetySquare.Digits] = new()
                {
                    ...
                    Question = "Welche Ziffer war bei {0} auf dem {1} Diamanten?",
                    Arguments = new()
                    {
                        ["red"] = "roten",
                        ["yellow"] = "gelben",
        ...
        [typeof(SSaturn)] = new()
        {
            ManualQuestions = new()
            {
                ["Where was the goal?"] = "Wo war das Ziel?",
            },
            Questions = new()
            {
                [SSaturn.Goal] = new()
        ...
        [typeof(SSbemailSongs)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the displayed songs in each stage?"] = "Welche Songs waren in welcher Stufe auf dem Display?",
            },
            Questions = new()
            {
                [SSbemailSongs.Songs] = new()
                {
                    ...
                    Question = "Welcher Song war bei {0} in Stufe {1} (hexadezimal) auf dem Display?",
                },
            },
            Discriminators = new()
            {
        ...
        [typeof(SScavengerHunt)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which tiles gave relevant clues in each stage?"] = "Auf welchen Feldern waren relevante Hinweise für welche Stufe?",
            },
            Questions = new()
            {
                [SScavengerHunt.ClueTiles] = new()
                {
                    ...
                    Question = "Auf welchem Feld war bei {0} ein für die {1}e Stufe relevanter Hinweis?",
                },
            },
        },
        ...
        [typeof(SSchlagDenBomb)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the contestant’s name and both scores?"] = "Wie lauteten beide Punktzahlen sowie der Name des Kandidaten?",
            },
            Questions = new()
            {
                [SSchlagDenBomb.ContestantName] = new()
                {
                    ...
                    Question = "Wie lautete bei {0} der Name des Kandidaten?",
                },
                [SSchlagDenBomb.ContestantScore] = new()
                {
                    // English: What was the contestant’s score in {0}?
                    Question = "Welche Punktzahl hatte bei {0} der Kandidat?",
                },
                [SSchlagDenBomb.BombScore] = new()
                {
                    // English: What was the bomb’s score in {0}?
                    Question = "Welche Punktzahl hatte bei {0} die Bombe?",
                },
            },
        },
        ...
        [typeof(SScramboozledEggain)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the encrypted words?"] = "Wie lauteten die verschlüsselten Wörter?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Prüfquadrate",
            ModuleNameDative = "Prüfquadraten",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What was the modified property of the first displayed square?"] = "Welches Merkmal war beim ersten Quadrat falsch?",
            },
            Questions = new()
            {
                [SScrutinySquares.FirstDifference] = new()
                {
                    ...
                    Question = "Welches Merkmal war bei {0} beim ersten Quadrat falsch?",
                    Answers = new()
                    {
                        ["Word"] = "Wort",
                        ["Color around word"] = "Rahmenfarbe",
                        ["Color of background"] = "Hintergrundfarbe",
                        ["Color of word"] = "Wortfarbe",
                    },
                },
            },
        },
        ...
        [typeof(SSeaShells)] = new()
        {
            ...
            Questions = new()
            {
                [SSeaShells.Question1] = new()
                {
                    ...
                    Question = "Wie lautete bei {0} das erste und zweite Wort in der {1}en Phrase?",
                },
                [SSeaShells.Question2] = new()
                {
                    // English: What were the third and fourth words in the {1} phrase in {0}?
                    // Example: What were the third and fourth words in the first phrase in Sea Shells?
                    Question = "Wie lautete bei {0} das dritte und vierte Wort in der {1}en Phrase?",
                },
                [SSeaShells.Question3] = new()
                {
                    // English: What was the end of the {1} phrase in {0}?
                    // Example: What was the end of the first phrase in Sea Shells?
                    Question = "Wie lautete bei {0} das Ende der {1}en Phrase?",
                },
            },
        },
        ...
        [typeof(SSemamorse)] = new()
        {
            ...
            Questions = new()
            {
                [SSemamorse.Color] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} das Display, das für den Startwert zum Einsatz kam?",
                    Answers = new()
                    {
                        ["red"] = "red",
                        ["green"] = "green",
                ...
                [SSemamorse.Letters] = new()
                {
                    ...
                    Question = "Welcher {1} kam bei {0} für den Startwert zum Einsatz?",
                    Arguments = new()
                    {
                        ["Morse"] = "Morse-Buchstabe",
                        ["semaphore"] = "Winker-Buchstabe",
                    },
                },
            },
        },
        ...
        [typeof(SSequencyclopedia)] = new()
        {
            ...
            Questions = new()
            {
                [SSequencyclopedia.Sequence] = new()
                {
                    ...
                    Question = "Welche Folge kam bei {0} vor?",
                },
            },
        },
        ...
        {
            ModuleName = "S.E.T.-Theorie",
            Gender = Gender.Feminine,
            ManualQuestions = new()
            {
                ["What equations were displayed in each stage?"] = "In welcher Stufe war welche Gleichung auf dem Display?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Formen und Bomben",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What was the initial letter?"] = "Was war der Startbuchstabe?",
            },
            Questions = new()
            {
                ...
                {
                    // English: What was the initial letter in {0}?
                    Question = "Was war bei {0} der Startbuchstabe?",
                },
            },
        },
        ...
        {
            ModuleName = "Formfluss",
            Gender = Gender.Masculine,
            ManualQuestions = new()
            {
                ["What was the initial shape?"] = "Welche Form war am Anfang da?",
            },
            Questions = new()
            {
                [SShapeShift.InitialShape] = new()
                {
                    ...
                    Question = "Welche Form war bei {0} am Anfang da?",
                },
            },
        },
        ...
        {
            ModuleName = "Verschobenes Labyrinth",
            ModuleNameDative = "Verschobenen Labyrinth",
            ManualQuestions = new()
            {
                ["What were the colors of the markers?"] = "Welche Farbe hatten die Markierungen?",
            },
            Questions = new()
            {
                [SShiftedMaze.Colors] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} die {1} Markierung?",
                    Arguments = new()
                    {
                        ["top-left"] = "obere linke",
                        ["top-right"] = "obere rechte",
        ...
        {
            ModuleName = "Shogi-Identifikation",
            ManualQuestions = new()
            {
                ["What was the displayed piece?"] = "Welcher Spielstein war zu sehen?",
            },
            Questions = new()
            {
                [SShogiIdentification.Piece] = new()
                {
                    ...
                    Question = "Welcher Spielstein war bei {0} zu sehen?",
                    Answers = new()
                    {
                        ["Go-Between"] = "Vermittler",
                        ["Pawn"] = "Bauer",
                        ["Side Mover"] = "Waagerechter Treiber",
                        ["Vertical Mover"] = "Senkrechter Treiber",
                        ["Bishop"] = "Läufer",
                        ["Rook"] = "Turm",
                        ["Dragon Horse"] = "Drachenpferd",
                        ["Dragon King"] = "Drachenkönig",
                        ["Lance"] = "Lanze",
                        ["Reverse Chariot"] = "Inverser Streitwagen",
                        ["Blind Tiger"] = "Blinder Tiger",
                        ["Ferocious Leopard"] = "Wilder Leopard",
                        ["Copper General"] = "Kupferner General",
                        ["Silver General"] = "Silberner General",
                        ["Gold General"] = "Goldener General",
                        ["Drunk Elephant"] = "Betrunkener Elefant",
                        ["Kirin"] = "Kirin",
                        ["Phoenix"] = "Phönix",
                        ["Queen"] = "Dame",
                        ["Flying Stag"] = "Fliegender Hirsch",
                        ["Flying Ox"] = "Fliegender Ochse",
                        ["Free Boar"] = "Freies Wildschwein",
                        ["Whale"] = "Wal",
                        ["White Horse"] = "Weißes Pferd",
                        ["King"] = "König",
                        ["Prince"] = "Prinz",
                        ["Horned Falcon"] = "Gehörnter Falke",
                        ["Soaring Eagle"] = "Fliegender Adler",
                        ["Lion"] = "Löwe",
                    },
                },
            },
        ...
        {
            ModuleName = "Zeichensprache",
            Gender = Gender.Feminine,
            ManualQuestions = new()
            {
                ["What was the deciphered word?"] = "Welches Wort wurde entziffert?",
            },
            Questions = new()
            {
                [SSignLanguage.Word] = new()
                {
                    ...
                    Question = "Welches Wort wurde bei {0} entziffert?",
                },
            },
        },
        ...
        {
            ModuleName = "Einarmiger Bandit",
            ModuleNameDative = "Einarmigen Bandit",
            Gender = Gender.Masculine,
            ManualQuestions = new()
            {
                ["What were the slots in each stage?"] = "Welche Symbole erschienen in welcher Stufe?",
            },
            Questions = new()
            {
                [SSillySlots.QSlot] = new()
                {
                    ...
                    Question = "Was war bei {0} das {1}e Symbol in der {2}en Stufe?",
                    Answers = new()
                    {
                        ["red bomb"] = "rote Bombe",
                        ...
                        ["green cherry"] = "grüne Kirsche",
                        ["green coin"] = "grüne Münze",
                        ["green grape"] = "grüne Traube",
                        ["blue bomb"] = "blaue Bombe",
                        ["blue cherry"] = "blaue Kirsche",
                        ["blue coin"] = "blaue Münze",
                        ["blue grape"] = "blaue Traube",
                    },
                },
            },
            Discriminators = new()
            {
                [SSillySlots.DSlot] = new()
                {
                    ...
                    Discriminator = "dem einarmigen Bandit, bei dem das {0}e Symbol in der {1}en Stufe eine {2} war,",
                    Arguments = new()
                    {
                        ["red bomb"] = "rote Bombe",
                        ["red cherry"] = "rote Kirsche",
        ...
        {
            ModuleName = "Silo-Authorisierung",
            Gender = Gender.Feminine,
            ManualQuestions = new()
            {
                ["What were the message type, encrypted message, and received authorization code?"] = "Was war der Nachrichtentyp, die verschlüsselte Nachricht und der empfangene Zugangscode?",
            },
            Questions = new()
            {
                [SSiloAuthorization.MessageType] = new()
                {
                    ...
                    Question = "Was war bei {0} der Nachrichtentyp?",
                },
                [SSiloAuthorization.EncryptedMessage] = new()
                {
                    ...
                    Question = "Was war bei {0} der {1}e Teil der verschlüsselten Nachricht?",
                },
                [SSiloAuthorization.AuthCode] = new()
                {
                    // English: What was the received authentication code in {0}?
                    Question = "Was war bei {0} der empfangene Zugangscode?",
                },
            },
        },
        ...
        [typeof(SSimonSamples)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the call samples in each stage?"] = "Welche Rufsamples kamen in welcher Stufe vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SSimonSays)] = new()
        {
            ...
            Questions = new()
            {
                [SSimonSays.QFlash] = new()
                {
                    ...
                    Question = "Welche Farbe kam bei {0} als {1}e in der endgültigen Farbfolge?",
                    Answers = new()
                    {
                        ["red"] = "rot",
                        ["yellow"] = "gelb",
            ...
            Discriminators = new()
            {
                [SSimonSays.DFlash] = new()
                {
                    ...
                    Discriminator = "dem Simon Sagt, dessen {0}e Farbe {1} war,",
                    Arguments = new()
                    {
                        ["red"] = "rot",
                        ["yellow"] = "gelb",
        ...
        {
            ModuleName = "Simon Schüttelt",
            ManualQuestions = new()
            {
                ["What was the flashing color sequence?"] = "Wie lautete die Farbfolge?",
            },
            Questions = new()
            {
        ...
        [typeof(SSimonScreams)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What flashing color was used in each stage?"] = "Welche Farbe aus der Folge war in welcher Stufe ausschlaggebend?",
                ["Which rules applied in which stage(s)?"] = "Welche Regeln trafen in welchen Stufen zu?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Simon Sendet",
            ManualQuestions = new()
            {
                ["What were the red, green, and blue received letters?"] = "Welche Buchstaben wurden in rot/grün/blau übermittelt?",
            },
            Questions = new()
            {
                [SSimonSends.ReceivedLetters] = new()
                {
                    ...
                    Question = "Welcher Buchstabe wurde bei {0} in {1} übermittelt?",
                    Arguments = new()
                    {
                        ["red"] = "rot",
                        ["green"] = "grün",
        ...
        {
            ModuleName = "Simon Serviert",
            ManualQuestions = new()
            {
                ["Who flashed in each course?"] = "Wer ist bei welchem Gang aufgeleuchtet?",
                ["Which items were not served in each course?"] = "Welche Gerichte wurden in welchem Gang nicht serviert?",
            },
            Questions = new()
            {
                ...
                [SSimonServes.Food] = new()
                {
                    ...
                    Question = "Welches Gericht wurde bei {0} bei Gang {1} nicht serviert?",
                    Answers = new()
                    {
                        ["Baked Batterys"] = "Gebackene Batterien",
                        ["Bamboozling Waffles"] = "Waffeln Übers Ohr Gehauen",
                        ["Big Boom Tortellini"] = "Tortellini Mit Mächtig Knall",
                        ["Blast Shrimps"] = "Gesprengte Shrimps",
                        ["Blastwave Compote"] = "Druckwellenkompott",
                        ["Bomb Brûlée"] = "Bombe Brûlée",
                        ["Boolean Waffles"] = "Boolesche Waffeln",
                        ["Boom Lager Beer"] = "Lagerbier Mit Knall",
                        ["Caesar Salad"] = "Cäsar-Salat",
                        ["Centurion Wings"] = "Zenturio-Flügel",
                        ["Colored Spare Ribs"] = "Gefärbter Rippenspeer",
                        ["Cruelo Juice"] = "Cruelo-Saft",
                        ["Defuse Juice"] = "Entschärf-Saft",
                        ["Defuse au Chocolat"] = "Defuse au Chocolat",
                        ["Deto Bull"] = "Deto-Bull",
                        ["Edgework Toast"] = "Peripherietoast",
                        ["Forget Cocktail"] = "Vergiss-Cocktail",
                        ["Forghetti Bombognese"] = "Verghetti Bombognese",
                        ["Indicator Tar Tar"] = "Indikator à la Tar Tar",
                        ["Morse Soup"] = "Morse-Suppe",
                        ["NATO Shrimps"] = "NATO-Shrimps",
                        ["Not Ice Cream"] = "Eiskrem Mal Anders",
                        ["Omelette au Bombage"] = "Omelette au Bombage",
                        ["Simon’s Special Mix"] = "Simons Spezialteller",
                        ["Solve Cake"] = "Lösungskuchen",
                        ["Status Light Rolls"] = "Statuslicht-Brötchen",
                        ["Strike Pie"] = "Fehlertorte",
                        ["Tasha’s Drink"] = "Tashas Drink",
                        ["Ticking Timecakes"] = "Tickende Zeitkuchen",
                        ["Veggie Blast Plate"] = "Gesprengte Veggie-Platte",
                        ["Wire Shake"] = "Draht-Shake",
                        ["Wire Spaghetti"] = "Drahtspaghetti",
                    },
                },
            },
        },
        ...
        {
            ModuleName = "Simon Formt",
            ManualQuestions = new()
            {
                ["What was the shape submitted at the end?"] = "Welche Form wurde am Ende eingegeben?",
            },
            Questions = new()
            {
                [SSimonShapes.SubmittedShape] = new()
                {
                    ...
                    Question = "Welche Form wurde bei {0} am Ende eingegeben?",
                },
            },
        },
        ...
        [typeof(SSimonShouts)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What letters flashed on each button?"] = "Welche Buchstaben wurden auf welchen Tasten übermittelt?",
            },
            Questions = new()
            {
        ...
        [typeof(SSimonShrieks)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["How many spaces clockwise from the arrow was each flash in the final sequence?"] = "Wie weit im Uhrzeigersinn vom Pfeil war welche Farbe in der endgültigen Folge?",
            },
            Questions = new()
            {
        ...
        [typeof(SSimonShuffles)] = new()
        {
            ...
            Questions = new()
            {
                [SSimonShuffles.Flashes] = new()
                {
                    ...
                    Question = "Welche Taste leuchtete bei {0} als {1}e in der {2}en Stufe?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Orange"] = "Orange",
        ...
        {
            ModuleName = "Simon Signalisiert",
            ManualQuestions = new()
            {
                ["What were the colors, shapes and number of directions of each arrow?"] = "Welcher Pfeil hatte welche Farbe, Form und Anzahl Richtungen?",
            },
            Questions = new()
            {
                [SSimonSignals.ColorToShape] = new()
                {
                    ...
                    Question = "Welche Form hatte bei {0} der {1} Pfeil?",
                    Arguments = new()
                    {
                        ["red"] = "rote",
                        ["green"] = "grüne",
                ...
                [SSimonSignals.ColorToRotations] = new()
                {
                    ...
                    Question = "Wie viele Richtungen hatte bei {0} der {1} Pfeil?",
                    Arguments = new()
                    {
                        ["red"] = "rote",
                        ["green"] = "grüne",
                ...
                [SSimonSignals.ShapeToColor] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} der Pfeil mit dieser Form?",
                    Answers = new()
                    {
                        ["red"] = "rote",
                        ["green"] = "grüne",
                ...
                [SSimonSignals.ShapeToRotations] = new()
                {
                    ...
                    Question = "Wie viele Richtungen hatte bei {0} der Pfeil mit dieser Form?",
                },
                [SSimonSignals.RotationsToColor] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} der Pfeil mit {1} Richtungen?",
                    Answers = new()
                    {
                        ["red"] = "rot",
                        ["green"] = "grün",
                ...
                [SSimonSignals.RotationsToShape] = new()
                {
                    ...
                    Question = "Welche Form hatte bei {0} der Pfeil mit {1} Richtungen?",
                },
            },
        },
        ...
        {
            ModuleName = "Simon Singt",
            ManualQuestions = new()
            {
                ["Which keys’ colors flashed in each stage?"] = "Welche Noten wurden in welcher Stufe durch Farben angezeigt?",
            },
            Questions = new()
            {
                [SSimonSings.Flashing] = new()
                {
                    ...
                    Question = "Die Farbe welcher Note war bei {0} die {1}e in Stufe {2}?",
                },
            },
        },
        ...
        {
            ModuleName = "Simon Lächelt",
            ManualQuestions = new()
            {
                ["What sounds did each button press play?"] = "Welche Taste löste welchen Sound aus?",
            },
            Questions = new()
            {
                [SSimonSmiles.Sounds] = new()
                {
                    ...
                    Question = "Welchen Sound löste bei {0} die {1}e Taste aus?",
                },
            },
        },
        ...
        {
            ModuleName = "Simon Quäkt",
            ManualQuestions = new()
            {
                ["Which sample buttons sounded in each stage?"] = "Welche Probetaste entsprach dem Geräusch in welcher Stufe?",
            },
            Questions = new()
            {
                [SSimonSounds.FlashingColors] = new()
                {
                    ...
                    Question = "Welche Probetaste ertönte bei {0} an {1}er Stelle in der endgültigen Folge?",
                    Answers = new()
                    {
                        ["red"] = "rot",
                        ["blue"] = "blau",
        ...
        [typeof(SSimonSpeaks)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the relevant attributes of the flashing bubbles?"] = "Was waren die relevanten Merkmale der aufleuchtenden Sprechblasen?",
            },
            Questions = new()
            {
                [SSimonSpeaks.Positions] = new()
                {
                    ...
                    Question = "Welche Sprechblase leuchtete bei {0} als erste auf?",
                    Answers = new()
                    {
                        ["top-left"] = "oben links",
                        ["top-middle"] = "oben Mitte",
                ...
                [SSimonSpeaks.Shapes] = new()
                {
                    ...
                    Question = "Welche Sprechblase leuchtete bei {0} als zweite auf?",
                },
                ...
                [SSimonSpeaks.Words] = new()
                {
                    ...
                    Question = "Welches Wort enthielt bei {0} die als vierte aufleuchtende Sprechblase?",
                },
                [SSimonSpeaks.Colors] = new()
                {
                    // English: What color was the bubble that flashed fifth in {0}?
                    Question = "Welche Farbe hatte bei {0} die als fünfte aufleuchtende Sprechblase?",
                    Answers = new()
                    {
                        ["black"] = "schwarz",
                        ["blue"] = "blau",
        ...
        [typeof(SSimonsStar)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which colors flashed?"] = "Welche Farben sind aufgeleuchtet?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Simon Stapelt",
            ManualQuestions = new()
            {
                ["Which colors flashed in each stage?"] = "Welche Farbe ist in welcher Stufe aufgeleuchtet?",
            },
            Questions = new()
            {
                [SSimonStacks.Colors] = new()
                {
                    ...
                    Question = "Welche Farbe ist bei {0} in der {1}en Stufe aufgeleuchtet?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Green"] = "Grün",
        ...
        [typeof(SSimonStates)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which color(s) flashed in the first three stages?"] = "Welche Farbe(n) leuchtete(n) in den ersten drei Stufen auf?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Simon Stoppt",
            ManualQuestions = new()
            {
                ["Which colors flashed in the output sequence?"] = "Welche Farben kamen in der vorgegebenen Farbfolge vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SSimonStores)] = new()
        {
            ...
            Questions = new()
            {
                ...
                [SSimonStores.QMultipleColors] = new()
                {
                    ...
                    Question = "Welche Farbe war bei {0} eine derer, die als {1}e aufleuchteten?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Green"] = "Grün",
            ...
            Discriminators = new()
            {
                [SSimonStores.DSingleColor] = new()
                {
                    ...
                    Discriminator = "dem Simon Speichert, bei dem {0} als {1}e aufleuchtete,",
                    Arguments = new()
                    {
                        ["red"] = "rot",
                        ["green"] = "grün",
                ...
                [SSimonStores.DMultipleColors] = new()
                {
                    ...
                    Discriminator = "dem Simon Speichert, bei dem {0} unter den als {1}e aufleuchtenden Farben war,",
                    Arguments = new()
                    {
                        ["red"] = "rot",
                        ["green"] = "grün",
        ...
        [typeof(SSimonSubdivides)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What colors were the cells that subdivided?"] = "Welche zerteilte Zelle hatte welche Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SSimonSwizzles)] = new()
        {
            ManualQuestions = new()
            {
                ["Where were ON and OFF?"] = "Wo waren die AN- und AUS-Gatter?",
                ["What was the hidden binary number?"] = "Was war die versteckte Binärzahl?",
            },
            Questions = new()
            {
                [SSimonSwizzles.Button] = new()
                {
                    ...
                    Question = "Wo war bei {0} das {1}-Gatter?",
                    Arguments = new()
                    {
                        ["OFF"] = "AUS",
                        ["ON"] = "AN",
                ...
                [SSimonSwizzles.Number] = new()
                {
                    ...
                    Question = "Was war bei {0} die versteckte Zahl?",
                },
            },
        },
        ...
        [typeof(SSimplySimon)] = new()
        {
            ...
            Questions = new()
            {
                [SSimplySimon.Flash] = new()
                {
                    ...
                    Question = "Was ist bei {0} in der {1}en Stufe aufgeleuchtet?",
                },
            },
        },
        ...
        {
            ModuleName = "Gleichzeitige Simons",
            ModuleNameDative = "Gleichzeitigen Simons",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
            ...
            Questions = new()
            {
                [SSimultaneousSimons.Flash] = new()
                {
                    ...
                    Question = "Welche Farbe ist bei {0} auf dem {2}en Simon als {1}e aufgeleuchtet?",
                    Answers = new()
                    {
                        ["Blue"] = "Blau",
                        ["Yellow"] = "Gelb",
        ...
        {
            ModuleName = "Schiefe Stellen",
            ModuleNameDative = "Schiefen Stellen",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What were the original numbers?"] = "Wie lauteten die Ziffern am Anfang?",
            },
            Questions = new()
            {
                [SSkewedSlots.OriginalNumbers] = new()
                {
                    ...
                    Question = "Welche Zahlen waren bei {0} am Anfang auf den Displays?",
                },
            },
        },
        ...
        [typeof(SSkewers)] = new()
        {
            ModuleName = "Aufgespießt",
            ManualQuestions = new()
            {
                ["What colors were the gems?"] = "Welche Farbe hatte welcher Edelstein?",
            },
            Questions = new()
            {
                [SSkewers.Color] = new()
                {
                    ...
                    Question = "Welche Farbe hatte bei {0} dieser Edelstein?",
                    Answers = new()
                    {
                        ["Black"] = "Schwarz",
                        ["Red"] = "Rot",
        ...
        [typeof(SSkyrim)] = new()
        {
            ManualQuestions = new()
            {
                ["Which races, weapons, enemies, cities, and dragon shouts were selectable, but not the solution?"] = "Welche Rassen, Waffen, Gegner, Städte und Drachenrufe waren auswählbar, aber nicht Teil der Lösung?",
            },
            Questions = new()
            {
                [SSkyrim.Race] = new()
                {
                    ...
                    Question = "Welches Volk kam bei {0} vor, war aber nicht die Lösung?",
                    Answers = new()
                    {
                        ["Nord"] = "Nord",
                        ["Khajiit"] = "Khajiit",
                        ...
                        ["Orc"] = "Orsimer",
                        ["Imperial"] = "Kaiserlichen",
                    },
                },
                [SSkyrim.Weapon] = new()
                {
                    // English: Which weapon was selectable, but not the solution, in {0}?
                    Question = "Welche Waffe kam bei {0} vor, war aber nicht die Lösung?",
                    Answers = new()
                    {
                        ["Axe of Whiterun"] = "Axt von Weißlauf",
                        ["Dawnbreaker"] = "Dämmerbrecher",
                        ["Windshear"] = "Windscherer",
                        ["Blade of Woe"] = "Klinge des Wehklagens",
                        ["Firiniel’s End"] = "Firiniels Ende",
                        ["Bow of the Hunt"] = "Bogen der Jagd",
                        ["Volendrung"] = "Volendrung",
                        ["Chillrend"] = "Eisspalter",
                ...
                [SSkyrim.Enemy] = new()
                {
                    ...
                    Question = "Welcher Gegner kam bei {0} vor, war aber nicht die Lösung?",
                    Answers = new()
                    {
                        ["Alduin"] = "Alduin",
                        ["Blood Dragon"] = "Blutdrache",
                        ["Cave Bear"] = "Höhlenbär",
                        ["Dragon Priest"] = "Drachenpriester",
                        ["Draugr"] = "Draugr",
                        ["Draugr Overlord"] = "Höherer Draugrfürst",
                        ["Frost Troll"] = "Eistroll",
                        ["Frostbite Spider"] = "Frostbissspinne",
                        ["Mudcrab"] = "Schlammkrabbe",
                    },
                },
                [SSkyrim.City] = new()
                {
                    // English: Which city was selectable, but not the solution, in {0}?
                    Question = "Welches Stadt kam bei {0} vor, war aber nicht die Lösung?",
                    Answers = new()
                    {
                ...
                [SSkyrim.DragonShout] = new()
                {
                    ...
                    Question = "Welcher Drachenschrei kam bei {0} vor, war aber nicht die Lösung?",
                },
            },
        },
        ...
        [typeof(SSlowMath)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the last triplet of letters?"] = "Was war das letzte Buchstabentripel?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Kleiner Kreis",
            ModuleNameDative = "Kleinen Kreis",
            Gender = Gender.Masculine,
            ManualQuestions = new()
            {
            ...
            Questions = new()
            {
                [SSmallCircle.Shift] = new()
                {
                    ...
                    Question = "Um wie viele Stellen ist die Folge bei {0} verschoben worden?",
                },
        ...
        [typeof(SSmashMarryKill)] = new()
        {
            ManualQuestions = new()
            {
                ["What category was each module in?"] = "Welches Modul war in welcher Kategorie?",
            },
            Questions = new()
            {
                [SSmashMarryKill.Category] = new()
                {
                    ...
                    Question = "{1} war bei {0} in welcher Kategorie?",
                },
                [SSmashMarryKill.Module] = new()
                {
                    ...
                    Question = "Welches Modul war bei {0} in der Kategorie {1}?",
                },
            },
            Discriminators = new()
            {
        ...
        {
            ModuleName = "Schneeflocken",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What were the displayed snowflakes?"] = "Welche Schneeflocken waren zu sehen?",
            },
            Questions = new()
            {
                [SSnowflakes.DisplayedSnowflakes] = new()
                {
                    ...
                    Question = "Welche Schneeflocke war bei {0} auf der {1} Taste?",
                    Arguments = new()
                    {
                        ["top"] = "oberen",
                        ["right"] = "rechten",
        ...
        [typeof(SSonicKnuckles)] = new()
        {
            ManualQuestions = new()
            {
                ["Which monitor and badnik were shown?"] = "Welcher Monitor und welcher Bösewicht war zu sehen?",
            },
            Questions = new()
            {
        ...
        [typeof(SSonicTheHedgehog)] = new()
        {
            ManualQuestions = new()
            {
                ["Which sound was played by each screen?"] = "Welcher Bildschirm löste welchen Sound aus?",
                ["What were the pictures?"] = "Welche Bilder kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SSouvenir)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the first module the other Souvenir asked a question about?"] = "Von welchem Modul handelte die erste Frage auf dem anderen Souvenir?",
            },
            Questions = new()
            {
                [SSouvenir.FirstQuestion] = new()
                {
                    ...
                    Question = "Zu welchem Modul hat das andere Souvenir auf dieser Bombe als erstes gefragt?",
                },
            },
            Discriminators = new()
            {
        ...
        {
            ModuleName = "Weltraumhandel",
            Gender = Gender.Masculine,
            ManualQuestions = new()
            {
                ["What was the maximum tax amount per vessel?"] = "Was war der Steuerhöchstbetrag pro Raumschiff?",
            },
            Questions = new()
            {
                [SSpaceTraders.MaxTax] = new()
                {
                    ...
                    Question = "Was war bei {0} der Steuerhöchstbetrag pro Raumschiff?",
                },
            },
        },
        ...
        [typeof(SSplittingTheLoot)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which bag was initially colored?"] = "Welcher Sack war am Anfang bereits gefärbt?",
            },
            Questions = new()
            {
        ...
        [typeof(SSpongebobBirthdayIdentification)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the submitted names?"] = "Welche Namen wurden eingegeben?",
            },
            Questions = new()
            {
        ...
        [typeof(SStability)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the lit LEDs’ colors?"] = "Welche Farbe hatte welche LED, die an war?",
                ["What was the identification number?"] = "Wie lautete die Identifikationsnummer?",
            },
            Questions = new()
            {
        ...
        [typeof(SStars)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the digit in the center?"] = "Welche Ziffer war in der Mitte?",
            },
            Questions = new()
            {
                [SStars.Center] = new()
        ...
        [typeof(SStarstruck)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which stars were shown?"] = "Welche Sterne waren zu sehen?",
            },
            Questions = new()
            {
        ...
        [typeof(SStateOfAggregation)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What element was shown?"] = "Welches Element war zu sehen?",
            },
            Questions = new()
            {
        ...
        [typeof(SStellar)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the letters?"] = "Welche Buchstaben kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SStroopsTest)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was each submitted word/color?"] = "Welche Wörter/Farben wurden eingegeben?",
            },
            Questions = new()
            {
        ...
        [typeof(SStupidSlots)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the values of each arrow?"] = "Welcher Pfeil hatte welchen Wert?",
            },
            Questions = new()
            {
        ...
        [typeof(SSubblyJubbly)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the replacement phrases?"] = "Wie lauteten die Ersatzphrasen?",
            },
            Questions = new()
            {
        ...
        [typeof(SSubscribeToPewdiepie)] = new()
        {
            ManualQuestions = new()
            {
                ["How many subscribers do Pewdiepie and T-Series have?"] = "Wie viele Abonnenten hatten Pewdiepie und T-Series?",
            },
            Questions = new()
            {
        ...
        [typeof(SSubway)] = new()
        {
            ManualQuestions = new()
            {
                ["Which bread did the customer ask for?"] = "Welches Brot wurde vom Kunden verlangt?",
                ["Which item was not asked for?"] = "Welche Zutat wurde nicht verlangt?",
            },
            Questions = new()
            {
                [SSubway.Bread] = new()
        ...
        [typeof(SSugarSkulls)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What skulls were shown?"] = "Welche Schädel waren zu sehen?",
            },
            Questions = new()
            {
        ...
        [typeof(SSuitsAndColours)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the colours and suits of each cell?"] = "Welche Zelle hatte welche Farbe/Kartenfarbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SSUSadmin)] = new()
        {
            ManualQuestions = new()
            {
                ["Which security protocols were installed?"] = "Welche Sicherheitsprotokolle waren installiert?",
                ["What was the version number?"] = "Wie lautete die Versionsnummer?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Wechsellabyrinth",
            ManualQuestions = new()
            {
                ["What was the seed?"] = "Was war der Seedcode?",
                ["What was the starting maze color?"] = "Mit welcher Farbe ging es los?",
            },
            Questions = new()
            {
                ...
                [SSwitchingMaze.Color] = new()
                {
                    ...
                    Question = "Mit welcher Farbe ging es bei {0} los?",
                    Answers = new()
                    {
                        ["Red"] = "Rot",
                        ["Green"] = "Grün",
        ...
        {
            ModuleName = "Symbolzyklus",
            Gender = Gender.Masculine,
            ManualQuestions = new()
            {
                ["How many symbols were cycling on each screen?"] = "Auf welchem Display wurden wie viele Symbole angezeigt?",
            },
            Questions = new()
            {
                [SSymbolCycle.SymbolCounts] = new()
                {
                    ...
                    Question = "Aus wie vielen Symbole bestand bei {0} der Zyklus auf dem {1} Display?",
                    Arguments = new()
                    {
                        ["left"] = "linken",
                        ["right"] = "rechten",
        ...
        {
            ModuleName = "Symbolische Koordinaten",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["Which symbols were present in each stage?"] = "Welche Symbole kamen in welcher Stufe vor?",
            },
            Questions = new()
            {
                [SSymbolicCoordinates.Symbols] = new()
                {
                    ...
                    Question = "Was war bei {0} das {1} Symbol in der {2}en Stufe?",
                    Arguments = new()
                    {
                        ["left"] = "linke",
                        ["middle"] = "mittlere",
        ...
        [typeof(SSymbolicTasha)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What symbols were on the buttons?"] = "Welches Symbol war auf welcher Taste?",
                ["Which buttons flashed?"] = "Welche Tasten leuchteten auf?",
            },
            Questions = new()
            {
        ...
        [typeof(SSynapseSays)] = new()
        {
            ...
            Questions = new()
            {
                [SSynapseSays.Flashes] = new()
                {
                    ...
                    Question = "Welche Farbe ist bei {0} in der {2}en Stufe als {1}e aufgeleuchtet?",
                },
                [SSynapseSays.Positions] = new()
                {
                    ...
                    Question = "Welche Farbe war bei {0} in der {2}en Stufe an {1}er Stelle?",
                },
            },
        },
        ...
        [typeof(SSync125_3)] = new()
        {
            ManualQuestions = new()
            {
                ["What was displayed on the screen in each stage?"] = "Was war in welcher Stufe auf dem Display?",
            },
            Questions = new()
            {
                [SSync125_3.Word] = new()
        ...
        [typeof(SSynonyms)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which number was displayed?"] = "Welche Zahl war auf dem Display?",
            },
            Questions = new()
            {
        ...
        [typeof(SSysadmin)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What error code did you fix?"] = "Welcher Fehlercode wurde korrigiert?",
            },
            Questions = new()
            {
                [SSysadmin.FixedErrorCodes] = new()
                {
                    ...
                    Question = "Welcher Fehlercode wurde bei {0} behoben?",
                },
            },
        },
        ...
        [typeof(STAC)] = new()
        {
            ManualQuestions = new()
            {
                ["Which cards were swapped?"] = "Welche Karten wurden ausgetauscht?",
                ["Which cards were in your hand?"] = "Welche Karten waren in der Hand?",
            },
            Questions = new()
            {
                [STAC.SwappedCard] = new()
                {
                    ...
                    Question = "Welche Karte wurde bei {0} beim Kartentausch {1}?",
                    Arguments = new()
                    {
                ...
                [STAC.HeldCard] = new()
                {
                    ...
                    Question = "Welche Karte war bei {0} auf der Hand?",
                    Answers = new()
                    {
                        ["1"] = "1",
                        ["2"] = "2",
        ...
        [typeof(STenButtonColorCode)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the buttons’ initial colors in each stage?"] = "Welche Farben hatten die Tasten am Anfang welcher Stufe?",
            },
            Questions = new()
            {
        ...
        [typeof(STenpins)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the splits?"] = "Welche Splits kamen vor?",
            },
            Questions = new()
            {
                [STenpins.Splits] = new()
                {
                    ...
                    Answers = new()
                    {
                        ["Goal Posts"] = "Torpfosten",
                        ["Cincinnati"] = "Cincinnati",
                        ["Woolworth Store"] = "Woolworth-Laden",
                        ["Lily"] = "Lilie",
                        ["3-7 Split"] = "3-7-Split",
                        ["Cocked Hat"] = "Schiefer Hut",
                        ["4-7-10 Split"] = "4-7-10-Split",
                        ["Big Four"] = "Große Vier",
                        ["Greek Church"] = "Griechische Kirche",
                        ["Big Five"] = "Große Fünf",
                        ["Big Six"] = "Große Sechs",
                        ["HOW"] = "WIE",
                    },
        ...
        {
            ModuleName = "Tetriamanten",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What was the pulsing colour sequence?"] = "Wie lautete die pulsierende Farbfolge?",
            },
            Questions = new()
            {
        ...
        [typeof(STextField)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the displayed letter?"] = "Welcher Buchstabe kam vor?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Drittes Mal",
            ModuleNameDative = "Dritten Mal",
            ManualQuestions = new()
            {
                ["What were the display words?"] = "Welche Wörter standen auf dem Display?",
            },
        ...
        {
            ModuleName = "Dreißig-Dollar-Modul",
            ManualQuestions = new()
            {
                ["What sounds were played?"] = "Welche Sounds kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(STicTacToe)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the initial state of the field?"] = "Wie sah das Spielfeld am Anfang aus?",
            },
            Questions = new()
            {
            ...
            Discriminators = new()
            {
                [STicTacToe.DButton] = new()
                {
                    ...
                    Discriminator = "dem Tic-Tac-Toe, bei dem das hier auf der {0} Taste war,",
                    Arguments = new()
                    {
                        ["top-left"] = "oberen linken",
                        ["top-middle"] = "oberen mittleren",
        ...
        [typeof(STimezone)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the departure and destination city?"] = "Wie lauteten die Abfahrts- und Ankunftsstadt?",
            },
            Questions = new()
            {
        ...
        [typeof(STipToe)] = new()
        {
            ModuleName = "Auf Zehenspitzen",
            ManualQuestions = new()
            {
                ["Which squares were safe in rows 9 and 10?"] = "Welche Felder in Reihe 9 und 10 waren sicher?",
            },
            Questions = new()
            {
                [STipToe.SafeSquares] = new()
                {
                    ...
                    Question = "Welches Feld in Reihe {1} war bei {0} ungefährlich?",
                },
            },
        },
        ...
        {
            ModuleName = "Drunter und Drüber",
            ManualQuestions = new()
            {
                ["What was the word initially shown?"] = "Welches Wort war am Anfang auf dem Display?",
            },
            Questions = new()
            {
                [STopsyTurvy.Word] = new()
                {
                    ...
                    Question = "Welches Wort war bei {0} am Anfang auf dem Display?",
                },
            },
        },
        ...
        {
            ModuleName = "Übertragung Durch Berührung",
            Gender = Gender.Feminine,
            ManualQuestions = new()
            {
                ["What was the transmitted word?"] = "Welches Wort wurde übermittelt?",
                ["In what order was the Braille read?"] = "In welcher Reihenfolge wurde das Braille gelesen?",
            },
            Questions = new()
            {
                [STouchTransmission.Word] = new()
                {
                    ...
                    Question = "Was war bei {0} das übermittelte Wort?",
                },
                [STouchTransmission.Order] = new()
                {
                    // English: In what order was the Braille read in {0}?
                    Question = "In welcher Reihenfolge wurde bei {0} das Braille gelesen?",
                    Answers = new()
                    {
                        ["Standard Braille Order"] = "Standard-Braille-Reihenfolge",
                        ["Individual Reading Order"] = "Einzelne Lesereihenfolge",
                        ["Merged Reading Order"] = "Gemeinsame Lesereihenfolge",
                        ["Chinese Reading Order"] = "Chinesische Lesereihenfolge",
                    },
                },
            },
        },
        ...
        {
            ModuleName = "Toxische Kristalle",
            ModuleNameDative = "Toxischen Kristallen",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What letter was written on the casing when solving?"] = "Welcher Buchstabe stand beim Entschärfen auf dem Gehäuse?",
            },
            Questions = new()
            {
                [SToxicCrystals.Letter] = new()
                {
                    ...
                    Question = "Welcher Buchstabe stand bei {0} beim Entschärfen auf dem Gehäuse?",
                },
            },
        },
        ...
        {
            ModuleName = "Übermitteltes Morse",
            ModuleNameDative = "Übermittelten Morse",
            ManualQuestions = new()
            {
                ["What were the received messages?"] = "Welche Nachrichten wurden übertragen?",
            },
            Questions = new()
            {
                [STransmittedMorse.Message] = new()
                {
                    ...
                    Question = "Welche Nachricht wurde bei {0} als {1}e empfangen?",
                },
            },
        },
        ...
        {
            ModuleName = "Stammesrat",
            Gender = Gender.Masculine,
            ManualQuestions = new()
            {
                ["What were the northeast and southwest names?"] = "Welche Namen waren im Nordosten und Südwesten?",
            },
            Questions = new()
            {
        ...
        [typeof(STrickyTetrisPieces)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the the shape of the first piece you pressed?"] = "Welche Form hatte das als erstes eingegebene Teil?",
                ["What was the second color palette that the pieces converted to?"] = "In welche zweite Farbpalette haben sich die Teile verwandelt?",
            },
            Questions = new()
            {
        ...
        [typeof(STripleTerm)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the passwords?"] = "Wie lauteten die Passwörter?",
            },
            Questions = new()
            {
        ...
        [typeof(STwoBits)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the correct three query responses?"] = "Welche Antwort kam auf die drei korrekten Anfragen?",
            },
            Questions = new()
            {
                [STwoBits.QResponse] = new()
                {
                    ...
                    Question = "Was war bei {0} das {1}e korrekte Anfrageergebnis?",
                },
            },
            Discriminators = new()
            {
                [STwoBits.DResponse] = new()
                {
                    ...
                    Discriminator = "den Zwei Bits, bei denen das {0}e korrekte Anfrageergebnis {1} war, ",
                },
            },
        },
        ...
        [typeof(STwodoku)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Where were the digits, symbols, and highlights?"] = "Welche Ziffern, Symbole und Hervorhebungen waren wo?",
            },
            Questions = new()
            {
                [STwodoku.Givens] = new()
        ...
        {
            ModuleName = "UFO-Satelliten",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["Which numbers were present?"] = "Welche Zahlen kamen vor?",
            },
            Questions = new()
            {
                [SUfoSatellites.Numbers] = new()
                {
                    ...
                    Question = "Welche Zahl war bei {0} nicht vorhanden?",
                },
            },
        },
        ...
        [typeof(SUltraStores)] = new()
        {
            ...
            Questions = new()
            {
                [SUltraStores.SingleRotation] = new()
                {
                    ...
                    Question = "Welche Rotation war bei {0} die {1}e in der {2}en Stufe?",
                },
        ...
        [typeof(SUncoloredSquares)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the colors used in the first stage?"] = "Welche Farben kamen in der ersten Stufe zum Einsatz?",
            },
            Questions = new()
            {
        ...
        [typeof(SUncoloredSwitches)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the initial switch state?"] = "Wie sahen die Schalter am Anfang aus?",
                ["What were the LED colors?"] = "Welche LED hatte welche Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SUncolourFlash)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the initial “YES” and “NO” sequences?"] = "Wie lauteten die „YES“- und „NO“-Folgen am Anfang?",
            },
            Questions = new()
            {
        ...
        [typeof(SUndertunneling)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the position in the maze after completing the first phase?"] = "Wo im Labyrinth war der Spieler am Ende der ersten Phase?",
            },
            Questions = new()
            {
        ...
        [typeof(SUnicode)] = new()
        {
            ManualQuestions = new()
            {
                ["What were the symbols?"] = "Welche Zeichen kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SUNO)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the starting card?"] = "Was war die Startkarte?",
            },
            Questions = new()
            {
        ...
        [typeof(SUnpleasantSquares)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What color was each square?"] = "Welche Farbe hatte welches Feld?",
            },
            Questions = new()
            {
        ...
        [typeof(SUSACycle)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which states were displayed?"] = "Welche Staaten kamen vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SUSAMaze)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which state did you depart from?"] = "Welcher Staat war Ausgangspunkt der Reise?",
            },
            Questions = new()
            {
                [SUSAMaze.Origin] = new()
        ...
        [typeof(SV)] = new()
        {
            ManualQuestions = new()
            {
                ["Which words were shown?"] = "Welche Wörter kamen vor?",
            },
            Questions = new()
            {
                [SV.QWords] = new()
        ...
        {
            ModuleName = "Ventile",
            ModuleNameDative = "Ventilen",
            Gender = Gender.Plural,
            ManualQuestions = new()
            {
                ["What was the initial state?"] = "Was war der Anfangszustand?",
            },
            Questions = new()
            {
        ...
        [typeof(SVaricoloredSquares)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the initially pressed color?"] = "Welche Farbe wurde als erste eingegeben?",
            },
            Questions = new()
            {
        ...
        [typeof(SVariety)] = new()
        {
            ...
            {
                ["What were the LED colors?"] = "Welche LED hatte welche Farbe?",
                ["What was n for the colored knobs and bulbs?"] = "Was war n für die farbigen Drehregler und Glühlampen?",
                ["What digits were displayed on the digit display?"] = "Welche Ziffern waren auf dem Zifferndisplay?",
                ["What words were formable on the letter display?"] = "Welche Wörter konnten mit dem Buchstabendisplay gebildet werden?",
                ["What were the maximum values of the timers?"] = "Welchen Höchstwert hatten die Timer?",
            },
            Questions = new()
            {
                [SVariety.LED] = new()
        ...
        [typeof(SVectors)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the colors of the vectors?"] = "Welche Farben hatten die Vektoren?",
            },
            Questions = new()
            {
                [SVectors.Colors] = new()
        ...
        [typeof(SVexillology)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the flagpole colors?"] = "Welche Farben hatte die Fahnenstange?",
            },
            Questions = new()
            {
        ...
        [typeof(SVisualImpairment)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the desired colors?"] = "Welche Farben wurden verlangt?",
            },
            Questions = new()
            {
        ...
        [typeof(SWalkingCube)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which cells did the cube walk to?"] = "Welche Felder wurden vom Würfel abgelaufen?",
            },
            Questions = new()
            {
        ...
        [typeof(SWarningSigns)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the displayed sign?"] = "Welches Schild kam vor?",
            },
            Questions = new()
            {
        ...
        [typeof(SWasd)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the displayed location?"] = "Welche Örtlichkeit war auf dem Display?",
            },
            Questions = new()
            {
                [SWasd.DisplayedLocation] = new()
                {
                    ...
                    Question = "Welche Örtlichkeit war bei {0} auf dem Display?",
                },
            },
        },
        ...
        [typeof(SWatchingPaintDry)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["How many brush strokes were there?"] = "Wie viele Pinselstriche gab es?",
            },
            Questions = new()
            {
        ...
        [typeof(SWavetapping)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the color in the first two stages?"] = "Welche Farbe hatten die ersten zwei Stufen?",
            },
            Questions = new()
            {
        ...
        [typeof(SWeakestLink)] = new()
        {
            ...
            ManualModuleName = "Der Schwächste Fliegt!",
            ManualQuestions = new()
            {
                ["Who was eliminated?"] = "Wer wurde eliminiert?",
                ["Who joined you in the Money Phase?"] = "Wer kam in der Geldphase dazu?",
                ["What were the other contestants’ skills and correct answer ratios?"] = "Welche Skills und welche Antwortquote hatten die anderen Kandidaten?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "“Was” Kommt Danach",
            ManualQuestions = new()
            {
                ["What were the display text and color in each stage?"] = "Was stand in welcher Stufe auf dem Display und in welcher Farbe?",
            },
            Questions = new()
            {
        ...
        [typeof(SWhiteArrows)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the non-white arrows?"] = "Welche nicht-weißen Pfeile kamen vor?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "“Was” Steht Auf Dem Knopf",
            ManualQuestions = new()
            {
                ["What were the display words?"] = "Welche Wörter standen auf dem Display?",
            },
            ...
            Discriminators = new()
            {
                [SWhosOnFirst.DDisplay] = new()
                {
                    ...
                    Discriminator = "dem “Was” Steht Auf Dem Knopf, bei dem in der {1}en Stufe {0} auf dem Display stand,",
                },
            },
        },
        ...
        [typeof(SWhosOnMorse)] = new()
        {
            ManualQuestions = new()
            {
                ["What word was transmitted in each stage?"] = "Welches Wort wurde in welcher Stufe übermittelt?",
            },
            Questions = new()
            {
        ...
        [typeof(SWireSequence)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["How many wires of each color were there?"] = "Wie viele Drähte gab es von jeder Farbe?",
            },
            Questions = new()
            {
            ...
            Discriminators = new()
            {
                [SWireSequence.DColorCount] = new()
                {
                    ...
                    Arguments = new()
                    {
                        ...
                        ["blue wire"] = "blauen Draht",
                        ["black wire"] = "schwarzen Draht",
                        ["red wires"] = "roten Drähten",
                        ["blue wires"] = "blauen Drähten",
                        ["black wires"] = "schwarzen Drähten",
                    },
                },
            },
        },
        ...
        [typeof(SWorkingTitle)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was on the display?"] = "Was stand auf dem Display?",
            },
            Questions = new()
            {
        ...
        {
            ModuleName = "Der Welten Größter Taste",
            ModuleNameDative = "Der Welten Größte Taste",
            Gender = Gender.Feminine,
            ManualQuestions = new()
            {
            ...
            Questions = new()
            {
                [SWorldsLargestButton.QLabel] = new()
                {
                    ...
                    Question = "Was stand auf der Taste bei {0}?",
                },
            ...
            Discriminators = new()
            {
                [SWorldsLargestButton.DLabel] = new()
                {
                    ...
                    Discriminator = "der Der Welten Größte Taste, auf der “{0}” stand,",
                },
        ...
        [typeof(SWumbo)] = new()
        {
            ManualQuestions = new()
            {
                ["What was the number?"] = "Welche Zahl kam vor?",
            },
            Questions = new()
            {
                [SWumbo.Number] = new()
        ...
        [typeof(SXobekuJehT)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What song was played?"] = "Welcher Song wurde abgespielt?",
            },
            Questions = new()
            {
        ...
        [typeof(SXRing)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What symbols were scanned?"] = "Welche Symbole wurden gescannt?",
            },
            Questions = new()
            {
                [SXRing.Symbol] = new()
        ...
        [typeof(SXRotor)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["Which symbols were scanned?"] = "Welche Symbole wurden gescannt?",
            },
            Questions = new()
            {
                [SXRotor.Symbol] = new()
        ...
        [typeof(SYahtzee)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the first roll?"] = "Was wurde als erstes gewürfelt?",
            },
            Questions = new()
            {
        ...
        [typeof(SYellowArrows)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the starting row letter?"] = "Welcher Buchstabe entsprach der Startreihe?",
            },
            Questions = new()
            {
        ...
        [typeof(SYellowButtont)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What was the filename?"] = "Wie lautete der Dateiname?",
            },
            Questions = new()
            {
        ...
        [typeof(SZeroZero)] = new()
        {
            ...
            ManualQuestions = new()
            {
                ["What were the colors and number of points on each star?"] = "Welcher Stern hatte welche Farbe und wie viele Zacken?",
                ["Where were the colored squares?"] = "Welche Felder waren gefärbt?",
            },
            Questions = new()
            {
