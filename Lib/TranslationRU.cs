...
namespace Souvenir
{
    public class Translation_ru : TranslationBase<Translation_ru.TranslationInfo_ru>
    {
        ...
        public override string[] IntroTexts => Ut.NewArray(
            ...
            "Астрологи объявили неделю бомб...",  // Астрологи объявили неделю удачи... — Game, HOMM3
            ...
            "Экспертов нет, но вы держитесь...",  // Денег нет, но вы держитесь, всего доброго. — Dmitry Medvedev's infamous speech
            ...
            "А может тебе дать ещё ключ от квартиры...",  // А может тебе дать ключ от квартиры, где деньги лежат? — Movie "12 стульев"
            ...
            "Ты кнопку нажал, должен был 6 секунд держать!",  // Ты на пенёк сел, должен был косарь отдать! — Internet meme
            "Слово «бомба» и слово «смерть» одно и то же.",  // Слово "Ром" и слово "Смерть" для вас означает одно и тоже — Movie, Остров сокровищ
            ...
            "Стартуем!",  // Стартуем! — Internet meme
            ...
            "Бомба заминирована.",  // Тапок заминирован — Internet meme
