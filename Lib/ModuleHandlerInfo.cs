...
namespace Souvenir
{
    public struct ModuleHandlerInfo
    {
        ...
        public static implicit operator ModuleHandlerInfo((Func<ModuleData, IEnumerator<YieldInstruction>> processor, string moduleName, string contributor) value) => new(value.processor, value.moduleName, value.contributor);
    }
}